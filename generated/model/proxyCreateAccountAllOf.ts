...
export class ProxyCreateAccountAllOf {
    /**
    ...
    */
    'status': ProxyCreateAccountAllOf.StatusEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "Status",
            "type": "ProxyCreateAccountAllOf.StatusEnum"
        },
        {
            "name": "taxCompanyCode",
    ...
    static getAttributeTypeMap() {
        return ProxyCreateAccountAllOf.attributeTypeMap;
    }
}

export namespace ProxyCreateAccountAllOf {
