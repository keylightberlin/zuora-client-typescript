...
import { SubscribeRequestPaymentMethodGatewayOptionData } from './subscribeRequestPaymentMethodGatewayOptionData';
...
*/
export class SubscribeRequestPaymentMethod {
    /**
    ...
    */
    'streetNumber'?: string;
    /**
    * A gateway unique identifier that replaces sensitive payment method data or represents a gateway\'s unique customer profile. If you want to create an Amazon Pay payment method, specify `AmazonBillingAgreementId` for this field.   While `TokenId` is used to represent a customer profile, `SecondTokenId` is conditionally required for representing the underlying tokenized payment method. When the `Type` field is set to `CreditCardReferenceTransaction`, this field is required if the `CreditCardNumber` field is not specified.   **Character limit**: 255 **Values**: a string of 255 characters or fewer 
    */
    'tokenId'?: string;
    /**
    ...
    */
    'type': SubscribeRequestPaymentMethod.TypeEnum;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return SubscribeRequestPaymentMethod.attributeTypeMap;
    }
}

export namespace SubscribeRequestPaymentMethod {
