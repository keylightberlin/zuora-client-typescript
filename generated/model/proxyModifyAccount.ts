...
export class ProxyModifyAccount {
    ...
    */
    'crmId'?: string;
    /**
    * Currency that the customer is billed in.   You can update this field only when an account is in Draft status. After the account is activated, you cannot update this field. 
    */
    'currency'?: string;
    /**
    ...
    */
    'status'?: ProxyModifyAccount.StatusEnum;
    /**
    ...
    */
    'customerTypeNS'?: ProxyModifyAccount.CustomerTypeNSEnum;
    /**
    ...
    */
    'synctoNetSuiteNS'?: ProxyModifyAccount.SynctoNetSuiteNSEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "Status",
            "type": "ProxyModifyAccount.StatusEnum"
        },
        {
            "name": "taxCompanyCode",
        ...
        },
        {
            ...
            "type": "ProxyModifyAccount.CustomerTypeNSEnum"
        },
        {
            "name": "departmentNS",
        ...
        },
        {
            ...
            "type": "ProxyModifyAccount.SynctoNetSuiteNSEnum"
        }    ];

    static getAttributeTypeMap() {
        return ProxyModifyAccount.attributeTypeMap;
    }
}

export namespace ProxyModifyAccount {
