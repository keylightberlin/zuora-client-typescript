...
export class Invoice {
    ...
    */
    'dueDate'?: string;
    /**
    *  Specifies whether the invoice includes one-time charges.   **Character limit**: 5  **Values**: automatically generated from one of the following: `True` (default), `False` 
    */
    'includesOneTime'?: boolean;
    /**
    *  Specifies whether the invoice includes recurring charges.   **Character limit**: 5  **Values**: automatically generated from one of the following: `True` (default), `False` 
    */
    'includesRecurring'?: boolean;
    /**
    *  Specifies whether the invoice includes usage charges.   **Character limit**: 5  **Values**: automatically generated from one of the following: `True `(default), `False` 
    */
    ...
    */
    'refundAmount'?: number;
    /**
    *  Regenerates a PDF of an invoice that was already generated.  **Character limit**: 5  **Values**: `True`, `False` 
    */
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "baseName": "CreditBalanceAdjustmentAmount",
            "type": "number"
        },
        {
            "name": "dueDate",
        ...
        },
        {
            ...
            "baseName": "IncludesOneTime",
            "type": "boolean"
        },
        {
            "name": "includesRecurring",
            "baseName": "IncludesRecurring",
            "type": "boolean"
        },
        {
            "name": "includesUsage",
            "baseName": "IncludesUsage",
            "type": "boolean"
        },
        {
            "name": "invoiceDate",
        ...
        {
            "name": "regenerateInvoicePDF",
            "baseName": "RegenerateInvoicePDF",
            "type": "boolean"
        },
        {
            "name": "status",
