...
export class ProxyGetAccountAllOf {
    /**
    ...
    */
    'status'?: ProxyGetAccountAllOf.StatusEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "Status",
            "type": "ProxyGetAccountAllOf.StatusEnum"
        },
        {
            "name": "taxCompanyCode",
    ...
    static getAttributeTypeMap() {
        return ProxyGetAccountAllOf.attributeTypeMap;
    }
}

export namespace ProxyGetAccountAllOf {
