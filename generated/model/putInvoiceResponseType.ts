...
import { InvoiceObjectNSFields } from './invoiceObjectNSFields';
import { PutInvoiceResponseTypeAllOf } from './putInvoiceResponseTypeAllOf';

export class PutInvoiceResponseType {
    /**
    ...
    */
    'status'?: PutInvoiceResponseType.StatusEnum;
    /**
    ...
    */
    'transferredToAccounting'?: PutInvoiceResponseType.TransferredToAccountingEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "PutInvoiceResponseType.StatusEnum"
        },
        {
            "name": "success",
            "baseName": "success",
        ...
        },
        {
            ...
            "type": "PutInvoiceResponseType.TransferredToAccountingEnum"
        },
        {
            "name": "updatedById",
    ...
    static getAttributeTypeMap() {
        return PutInvoiceResponseType.attributeTypeMap;
    }
}

export namespace PutInvoiceResponseType {
