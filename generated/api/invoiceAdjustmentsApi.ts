...
import { ProxyCreateInvoiceAdjustment } from '../model/proxyCreateInvoiceAdjustment';
...
import { ProxyGetInvoiceAdjustment } from '../model/proxyGetInvoiceAdjustment';
import { ProxyModifyInvoiceAdjustment } from '../model/proxyModifyInvoiceAdjustment';
...
export enum InvoiceAdjustmentsApiApiKeys {
}

export class InvoiceAdjustmentsApi {
    ...
    public setApiKey(key: InvoiceAdjustmentsApiApiKeys, value: string) {
        (this.authentications as any)[InvoiceAdjustmentsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async objectDELETEInvoiceAdjustment (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ProxyDeleteResponse;  }> {
        const localVarPath = this.basePath + '/v1/object/invoice-adjustment/{id}'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling objectDELETEInvoiceAdjustment.');
        }
     ...
     */
    public async objectGETInvoiceAdjustment (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ProxyGetInvoiceAdjustment;  }> {
        const localVarPath = this.basePath + '/v1/object/invoice-adjustment/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling objectGETInvoiceAdjustment.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: ProxyGetInvoiceAdjustment;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ProxyGetInvoiceAdjustment");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async objectPOSTInvoiceAdjustment (createRequest: ProxyCreateInvoiceAdjustment, rejectUnknownFields?: boolean, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ProxyCreateOrModifyResponse;  }> {
        const localVarPath = this.basePath + '/v1/object/invoice-adjustment';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (createRequest === null || createRequest === undefined) {
            throw new Error('Required parameter createRequest was null or undefined when calling objectPOSTInvoiceAdjustment.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(createRequest, "ProxyCreateInvoiceAdjustment")
        };
     ...
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async objectPUTInvoiceAdjustment (id: string, modifyRequest: ProxyModifyInvoiceAdjustment, rejectUnknownFields?: boolean, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ProxyCreateOrModifyResponse;  }> {
        const localVarPath = this.basePath + '/v1/object/invoice-adjustment/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling objectPUTInvoiceAdjustment.');
        }

        // verify required parameter 'modifyRequest' is not null or undefined
        if (modifyRequest === null || modifyRequest === undefined) {
            throw new Error('Required parameter modifyRequest was null or undefined when calling objectPUTInvoiceAdjustment.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(modifyRequest, "ProxyModifyInvoiceAdjustment")
        };
