...
import { GETPaymentRunCollectionType } from '../model/gETPaymentRunCollectionType';
import { GETPaymentRunSummaryResponse } from '../model/gETPaymentRunSummaryResponse';
import { GETPaymentRunType } from '../model/gETPaymentRunType';
import { POSTPaymentRunRequest } from '../model/pOSTPaymentRunRequest';
import { PUTPaymentRunRequest } from '../model/pUTPaymentRunRequest';
...
export enum PaymentRunsApiApiKeys {
}

export class PaymentRunsApi {
    ...
    public setApiKey(key: PaymentRunsApiApiKeys, value: string) {
        (this.authentications as any)[PaymentRunsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param paymentRunId The unique ID of a payment run. For example, 402890245f097f39015f0f074a2e0566. 
     ...
     */
    public async dELETEPaymentRun (paymentRunId: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/payment-runs/{paymentRunId}'
            .replace('{' + 'paymentRunId' + '}', encodeURIComponent(String(paymentRunId)));
        ...
        // verify required parameter 'paymentRunId' is not null or undefined
        if (paymentRunId === null || paymentRunId === undefined) {
            throw new Error('Required parameter paymentRunId was null or undefined when calling dELETEPaymentRun.');
        }
     ...
     */
    public async gETPaymentRun (paymentRunId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETPaymentRunType;  }> {
        const localVarPath = this.basePath + '/v1/payment-runs/{paymentRunId}'
            .replace('{' + 'paymentRunId' + '}', encodeURIComponent(String(paymentRunId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'paymentRunId' is not null or undefined
        if (paymentRunId === null || paymentRunId === undefined) {
            throw new Error('Required parameter paymentRunId was null or undefined when calling gETPaymentRun.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETPaymentRunType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETPaymentRunType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async gETPaymentRunSummary (paymentRunId: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETPaymentRunSummaryResponse;  }> {
        const localVarPath = this.basePath + '/v1/payment-runs/{paymentRunId}/summary'
            .replace('{' + 'paymentRunId' + '}', encodeURIComponent(String(paymentRunId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'paymentRunId' is not null or undefined
        if (paymentRunId === null || paymentRunId === undefined) {
            throw new Error('Required parameter paymentRunId was null or undefined when calling gETPaymentRunSummary.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETPaymentRunSummaryResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETPaymentRunSummaryResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async gETPaymentRuns (zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, createdById?: string, createdDate?: Date, status?: 'Pending' | 'Processing' | 'Completed' | 'Error' | 'Canceled', targetDate?: string, updatedById?: string, updatedDate?: Date, sort?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETPaymentRunCollectionType;  }> {
        const localVarPath = this.basePath + '/v1/payment-runs';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        if (status !== undefined) {
            localVarQueryParameters['status'] = ObjectSerializer.serialize(status, "'Pending' | 'Processing' | 'Completed' | 'Error' | 'Canceled'");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETPaymentRunCollectionType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETPaymentRunCollectionType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pOSTPaymentRun (body: POSTPaymentRunRequest, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETPaymentRunType;  }> {
        const localVarPath = this.basePath + '/v1/payment-runs';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pOSTPaymentRun.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "POSTPaymentRunRequest")
        };
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTPaymentRun (paymentRunId: string, body: PUTPaymentRunRequest, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETPaymentRunType;  }> {
        const localVarPath = this.basePath + '/v1/payment-runs/{paymentRunId}'
            .replace('{' + 'paymentRunId' + '}', encodeURIComponent(String(paymentRunId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'paymentRunId' is not null or undefined
        if (paymentRunId === null || paymentRunId === undefined) {
            throw new Error('Required parameter paymentRunId was null or undefined when calling pUTPaymentRun.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pUTPaymentRun.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "PUTPaymentRunRequest")
        };
