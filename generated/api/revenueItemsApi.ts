...
import { GETRevenueItemsType } from '../model/gETRevenueItemsType';
import { GETRsRevenueItemsType } from '../model/gETRsRevenueItemsType';
import { PUTEventRIDetailType } from '../model/pUTEventRIDetailType';
import { PUTScheduleRIDetailType } from '../model/pUTScheduleRIDetailType';
...
export enum RevenueItemsApiApiKeys {
}

export class RevenueItemsApi {
    ...
    public setApiKey(key: RevenueItemsApiApiKeys, value: string) {
        (this.authentications as any)[RevenueItemsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async gETRevenueItemsByChargeRevenueEventNumber (eventNumber: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETRevenueItemsType;  }> {
        const localVarPath = this.basePath + '/v1/revenue-items/revenue-events/{event-number}'
            .replace('{' + 'event-number' + '}', encodeURIComponent(String(eventNumber)));
        ...
        // verify required parameter 'eventNumber' is not null or undefined
        if (eventNumber === null || eventNumber === undefined) {
            throw new Error('Required parameter eventNumber was null or undefined when calling gETRevenueItemsByChargeRevenueEventNumber.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETRevenueItemsType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETRevenueItemsType");
     ...
     * @param pageSize Number of rows returned per page. 
     */
    public async gETRevenueItemsByChargeRevenueSummaryNumber (crsNumber: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETRevenueItemsType;  }> {
        const localVarPath = this.basePath + '/v1/revenue-items/charge-revenue-summaries/{crs-number}'
            .replace('{' + 'crs-number' + '}', encodeURIComponent(String(crsNumber)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'crsNumber' is not null or undefined
        if (crsNumber === null || crsNumber === undefined) {
            throw new Error('Required parameter crsNumber was null or undefined when calling gETRevenueItemsByChargeRevenueSummaryNumber.');
        }
     ...
     * @param pageSize Number of rows returned per page. 
     */
    public async gETRevenueItemsByRevenueSchedule (rsNumber: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETRsRevenueItemsType;  }> {
        const localVarPath = this.basePath + '/v1/revenue-items/revenue-schedules/{rs-number}'
        ...
        if (rsNumber === null || rsNumber === undefined) {
            throw new Error('Required parameter rsNumber was null or undefined when calling gETRevenueItemsByRevenueSchedule.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETRsRevenueItemsType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETRsRevenueItemsType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTCustomFieldsonRevenueItemsByRevenueEvent (eventNumber: string, request: PUTEventRIDetailType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/revenue-items/revenue-events/{event-number}'
            .replace('{' + 'event-number' + '}', encodeURIComponent(String(eventNumber)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'eventNumber' is not null or undefined
        if (eventNumber === null || eventNumber === undefined) {
            throw new Error('Required parameter eventNumber was null or undefined when calling pUTCustomFieldsonRevenueItemsByRevenueEvent.');
        }

        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pUTCustomFieldsonRevenueItemsByRevenueEvent.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "PUTEventRIDetailType")
        };
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTCustomFieldsonRevenueItemsByRevenueSchedule (rsNumber: string, request: PUTScheduleRIDetailType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/revenue-items/revenue-schedules/{rs-number}'
            .replace('{' + 'rs-number' + '}', encodeURIComponent(String(rsNumber)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'rsNumber' is not null or undefined
        if (rsNumber === null || rsNumber === undefined) {
            throw new Error('Required parameter rsNumber was null or undefined when calling pUTCustomFieldsonRevenueItemsByRevenueSchedule.');
        }

        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pUTCustomFieldsonRevenueItemsByRevenueSchedule.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "PUTScheduleRIDetailType")
        };
