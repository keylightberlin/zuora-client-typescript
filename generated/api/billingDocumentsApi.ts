...
import { BillingDocumentQueryResponseElementType } from '../model/billingDocumentQueryResponseElementType';
import { GETBillingDocumentFilesDeletionJobResponse } from '../model/gETBillingDocumentFilesDeletionJobResponse';
import { GenerateBillingDocumentResponseType } from '../model/generateBillingDocumentResponseType';
import { POSTBillingDocumentFilesDeletionJobRequest } from '../model/pOSTBillingDocumentFilesDeletionJobRequest';
import { POSTBillingDocumentFilesDeletionJobResponse } from '../model/pOSTBillingDocumentFilesDeletionJobResponse';
import { PostGenerateBillingDocumentType } from '../model/postGenerateBillingDocumentType';
...
export enum BillingDocumentsApiApiKeys {
}

export class BillingDocumentsApi {
    ...
    public setApiKey(key: BillingDocumentsApiApiKeys, value: string) {
        (this.authentications as any)[BillingDocumentsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param jobId The unique ID of a billing document file deletion job. For example, 2c92c8f83dc4f752013dc72c24ee016c.
     ...
     */
    public async gETBillingDocumentFilesDeletionJob (jobId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETBillingDocumentFilesDeletionJobResponse;  }> {
        const localVarPath = this.basePath + '/v1/accounts/billing-documents/files/deletion-jobs/{jobId}'
        ...
        if (jobId === null || jobId === undefined) {
            throw new Error('Required parameter jobId was null or undefined when calling gETBillingDocumentFilesDeletionJob.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETBillingDocumentFilesDeletionJobResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETBillingDocumentFilesDeletionJobResponse");
     ...
     * @param accountId The ID of the customer account that the billing documents are associated with.  
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param pageSize Number of rows returned per page. 
     * @param documentDate The date of the billing document. It represents the invoice date for invoices, credit memo date for credit memos, and debit memo date for debit memos. 
     ...
     */
    public async gETBillingDocuments (accountId: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, documentDate?: string, status?: 'Draft' | 'Posted' | 'Canceled' | 'Error', sort?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: BillingDocumentQueryResponseElementType;  }> {
        const localVarPath = this.basePath + '/v1/billing-documents';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (accountId === null || accountId === undefined) {
            throw new Error('Required parameter accountId was null or undefined when calling gETBillingDocuments.');
        }
        ...
        if (documentDate !== undefined) {
            localVarQueryParameters['documentDate'] = ObjectSerializer.serialize(documentDate, "string");
        }

        if (status !== undefined) {
            localVarQueryParameters['status'] = ObjectSerializer.serialize(status, "'Draft' | 'Posted' | 'Canceled' | 'Error'");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: BillingDocumentQueryResponseElementType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "BillingDocumentQueryResponseElementType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pOSTBillingDocumentFilesDeletionJob (body: POSTBillingDocumentFilesDeletionJobRequest, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: POSTBillingDocumentFilesDeletionJobResponse;  }> {
        const localVarPath = this.basePath + '/v1/accounts/billing-documents/files/deletion-jobs';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pOSTBillingDocumentFilesDeletionJob.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "POSTBillingDocumentFilesDeletionJobRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: POSTBillingDocumentFilesDeletionJobResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "POSTBillingDocumentFilesDeletionJobResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pOSTGenerateBillingDocuments (id: string, body: PostGenerateBillingDocumentType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GenerateBillingDocumentResponseType;  }> {
        const localVarPath = this.basePath + '/v1/accounts/{id}/billing-documents/generate'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling pOSTGenerateBillingDocuments.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pOSTGenerateBillingDocuments.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "PostGenerateBillingDocumentType")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GenerateBillingDocumentResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GenerateBillingDocumentResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
