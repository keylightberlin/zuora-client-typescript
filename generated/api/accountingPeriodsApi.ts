...
import { GETAccountingPeriodType } from '../model/gETAccountingPeriodType';
import { GETAccountingPeriodsType } from '../model/gETAccountingPeriodsType';
import { POSTAccountingPeriodResponseType } from '../model/pOSTAccountingPeriodResponseType';
import { POSTAccountingPeriodType } from '../model/pOSTAccountingPeriodType';
import { PUTAccountingPeriodType } from '../model/pUTAccountingPeriodType';
...
export enum AccountingPeriodsApiApiKeys {
}

export class AccountingPeriodsApi {
    ...
    public setApiKey(key: AccountingPeriodsApiApiKeys, value: string) {
        (this.authentications as any)[AccountingPeriodsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async dELETEAccountingPeriod (apId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/accounting-periods/{ap-id}'
            .replace('{' + 'ap-id' + '}', encodeURIComponent(String(apId)));
        ...
        // verify required parameter 'apId' is not null or undefined
        if (apId === null || apId === undefined) {
            throw new Error('Required parameter apId was null or undefined when calling dELETEAccountingPeriod.');
        }
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async gETAccountingPeriod (apId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETAccountingPeriodType;  }> {
        const localVarPath = this.basePath + '/v1/accounting-periods/{ap-id}'
            .replace('{' + 'ap-id' + '}', encodeURIComponent(String(apId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'apId' is not null or undefined
        if (apId === null || apId === undefined) {
            throw new Error('Required parameter apId was null or undefined when calling gETAccountingPeriod.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETAccountingPeriodType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETAccountingPeriodType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async gETAllAccountingPeriods (zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETAccountingPeriodsType;  }> {
        const localVarPath = this.basePath + '/v1/accounting-periods';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETAccountingPeriodsType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETAccountingPeriodsType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pOSTAccountingPeriod (request: POSTAccountingPeriodType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: POSTAccountingPeriodResponseType;  }> {
        const localVarPath = this.basePath + '/v1/accounting-periods';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pOSTAccountingPeriod.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "POSTAccountingPeriodType")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: POSTAccountingPeriodResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "POSTAccountingPeriodResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTCloseAccountingPeriod (apId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/accounting-periods/{ap-id}/close'
            .replace('{' + 'ap-id' + '}', encodeURIComponent(String(apId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'apId' is not null or undefined
        if (apId === null || apId === undefined) {
            throw new Error('Required parameter apId was null or undefined when calling pUTCloseAccountingPeriod.');
        }
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTPendingCloseAccountingPeriod (apId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/accounting-periods/{ap-id}/pending-close'
            .replace('{' + 'ap-id' + '}', encodeURIComponent(String(apId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'apId' is not null or undefined
        if (apId === null || apId === undefined) {
            throw new Error('Required parameter apId was null or undefined when calling pUTPendingCloseAccountingPeriod.');
        }
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTReopenAccountingPeriod (apId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/accounting-periods/{ap-id}/reopen'
            .replace('{' + 'ap-id' + '}', encodeURIComponent(String(apId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'apId' is not null or undefined
        if (apId === null || apId === undefined) {
            throw new Error('Required parameter apId was null or undefined when calling pUTReopenAccountingPeriod.');
        }
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTRunTrialBalance (apId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/accounting-periods/{ap-id}/run-trial-balance'
            .replace('{' + 'ap-id' + '}', encodeURIComponent(String(apId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'apId' is not null or undefined
        if (apId === null || apId === undefined) {
            throw new Error('Required parameter apId was null or undefined when calling pUTRunTrialBalance.');
        }
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTUpdateAccountingPeriod (apId: string, request: PUTAccountingPeriodType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/accounting-periods/{ap-id}'
            .replace('{' + 'ap-id' + '}', encodeURIComponent(String(apId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'apId' is not null or undefined
        if (apId === null || apId === undefined) {
            throw new Error('Required parameter apId was null or undefined when calling pUTUpdateAccountingPeriod.');
        }

        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pUTUpdateAccountingPeriod.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "PUTAccountingPeriodType")
        };
