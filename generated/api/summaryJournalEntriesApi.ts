...
import { GETJournalEntriesInJournalRunType } from '../model/gETJournalEntriesInJournalRunType';
import { GETJournalEntryDetailType } from '../model/gETJournalEntryDetailType';
import { POSTJournalEntryResponseType } from '../model/pOSTJournalEntryResponseType';
import { POSTJournalEntryType } from '../model/pOSTJournalEntryType';
import { PUTBasicSummaryJournalEntryType } from '../model/pUTBasicSummaryJournalEntryType';
...
export enum SummaryJournalEntriesApiApiKeys {
}

export class SummaryJournalEntriesApi {
    ...
    public setApiKey(key: SummaryJournalEntriesApiApiKeys, value: string) {
        (this.authentications as any)[SummaryJournalEntriesApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async dELETESummaryJournalEntry (jeNumber: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/journal-entries/{je-number}'
            .replace('{' + 'je-number' + '}', encodeURIComponent(String(jeNumber)));
        ...
        // verify required parameter 'jeNumber' is not null or undefined
        if (jeNumber === null || jeNumber === undefined) {
            throw new Error('Required parameter jeNumber was null or undefined when calling dELETESummaryJournalEntry.');
        }
     ...
     */
    public async gETAllSummaryJournalEntries (jrNumber: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETJournalEntriesInJournalRunType;  }> {
        const localVarPath = this.basePath + '/v1/journal-entries/journal-runs/{jr-number}'
            .replace('{' + 'jr-number' + '}', encodeURIComponent(String(jrNumber)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'jrNumber' is not null or undefined
        if (jrNumber === null || jrNumber === undefined) {
            throw new Error('Required parameter jrNumber was null or undefined when calling gETAllSummaryJournalEntries.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETJournalEntriesInJournalRunType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETJournalEntriesInJournalRunType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async gETSummaryJournalEntry (jeNumber: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETJournalEntryDetailType;  }> {
        const localVarPath = this.basePath + '/v1/journal-entries/{je-number}'
            .replace('{' + 'je-number' + '}', encodeURIComponent(String(jeNumber)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'jeNumber' is not null or undefined
        if (jeNumber === null || jeNumber === undefined) {
            throw new Error('Required parameter jeNumber was null or undefined when calling gETSummaryJournalEntry.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETJournalEntryDetailType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETJournalEntryDetailType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pOSTSummaryJournalEntry (request: POSTJournalEntryType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: POSTJournalEntryResponseType;  }> {
        const localVarPath = this.basePath + '/v1/journal-entries';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pOSTSummaryJournalEntry.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "POSTJournalEntryType")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: POSTJournalEntryResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "POSTJournalEntryResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTBasicSummaryJournalEntry (jeNumber: string, request: PUTBasicSummaryJournalEntryType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/journal-entries/{je-number}/basic-information'
            .replace('{' + 'je-number' + '}', encodeURIComponent(String(jeNumber)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'jeNumber' is not null or undefined
        if (jeNumber === null || jeNumber === undefined) {
            throw new Error('Required parameter jeNumber was null or undefined when calling pUTBasicSummaryJournalEntry.');
        }

        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pUTBasicSummaryJournalEntry.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "PUTBasicSummaryJournalEntryType")
        };
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTSummaryJournalEntry (jeNumber: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/journal-entries/{je-number}/cancel'
            .replace('{' + 'je-number' + '}', encodeURIComponent(String(jeNumber)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'jeNumber' is not null or undefined
        if (jeNumber === null || jeNumber === undefined) {
            throw new Error('Required parameter jeNumber was null or undefined when calling pUTSummaryJournalEntry.');
        }
