...
import { ProxyCreateContact } from '../model/proxyCreateContact';
...
import { ProxyGetContact } from '../model/proxyGetContact';
import { ProxyModifyContact } from '../model/proxyModifyContact';
...
export class ContactsApi {
     ...
     */
    public async objectDELETEContact (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ProxyDeleteResponse;  }> {
        const localVarPath = this.basePath + '/v1/object/contact/{id}'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling objectDELETEContact.');
        }
     ...
     */
    public async objectGETContact (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ProxyGetContact;  }> {
        const localVarPath = this.basePath + '/v1/object/contact/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling objectGETContact.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: ProxyGetContact;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ProxyGetContact");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async objectPOSTContact (createRequest: ProxyCreateContact, rejectUnknownFields?: boolean, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ProxyCreateOrModifyResponse;  }> {
        const localVarPath = this.basePath + '/v1/object/contact';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (createRequest === null || createRequest === undefined) {
            throw new Error('Required parameter createRequest was null or undefined when calling objectPOSTContact.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(createRequest, "ProxyCreateContact")
        };
     ...
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async objectPUTContact (id: string, modifyRequest: ProxyModifyContact, rejectUnknownFields?: boolean, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ProxyCreateOrModifyResponse;  }> {
        const localVarPath = this.basePath + '/v1/object/contact/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling objectPUTContact.');
        }

        // verify required parameter 'modifyRequest' is not null or undefined
        if (modifyRequest === null || modifyRequest === undefined) {
            throw new Error('Required parameter modifyRequest was null or undefined when calling objectPUTContact.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(modifyRequest, "ProxyModifyContact")
        };
     ...
     * @param contactId The ID of the contact that you want to scrub sensitive data from. 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async pUTScrubContact (contactId: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/contacts/{contactId}/scrub'
        ...
        if (contactId === null || contactId === undefined) {
            throw new Error('Required parameter contactId was null or undefined when calling pUTScrubContact.');
        }
