...
import { ProxyActionamendRequest } from '../model/proxyActionamendRequest';
import { ProxyActionamendResponse } from '../model/proxyActionamendResponse';
import { ProxyActioncreateRequest } from '../model/proxyActioncreateRequest';
import { ProxyActiondeleteRequest } from '../model/proxyActiondeleteRequest';
import { ProxyActionexecuteRequest } from '../model/proxyActionexecuteRequest';
import { ProxyActiongenerateRequest } from '../model/proxyActiongenerateRequest';
import { ProxyActionqueryMoreRequest } from '../model/proxyActionqueryMoreRequest';
import { ProxyActionqueryMoreResponse } from '../model/proxyActionqueryMoreResponse';
import { ProxyActionqueryRequest } from '../model/proxyActionqueryRequest';
import { ProxyActionqueryResponse } from '../model/proxyActionqueryResponse';
import { ProxyActionsubscribeRequest } from '../model/proxyActionsubscribeRequest';
import { ProxyActionupdateRequest } from '../model/proxyActionupdateRequest';
...
export class ActionsApi {
     ...
     * @param xZuoraWSDLVersion Zuora WSDL version number. 
     */
    public async actionPOSTamend (amendRequest: ProxyActionamendRequest, rejectUnknownFields?: boolean, zuoraEntityIds?: string, zuoraTrackId?: string, xZuoraWSDLVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ProxyActionamendResponse;  }> {
        const localVarPath = this.basePath + '/v1/action/amend';
        ...
        if (amendRequest === null || amendRequest === undefined) {
            throw new Error('Required parameter amendRequest was null or undefined when calling actionPOSTamend.');
        }
        ...
        localVarHeaderParams['X-Zuora-WSDL-Version'] = ObjectSerializer.serialize(xZuoraWSDLVersion, "string");
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(amendRequest, "ProxyActionamendRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: ProxyActionamendResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ProxyActionamendResponse");
     ...
     * @param xZuoraWSDLVersion Zuora WSDL version number. 
     */
    public async actionPOSTcreate (createRequest: ProxyActioncreateRequest, rejectUnknownFields?: boolean, zuoraEntityIds?: string, zuoraTrackId?: string, xZuoraWSDLVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Array<SaveResult>;  }> {
        const localVarPath = this.basePath + '/v1/action/create';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (createRequest === null || createRequest === undefined) {
            throw new Error('Required parameter createRequest was null or undefined when calling actionPOSTcreate.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(createRequest, "ProxyActioncreateRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: Array<SaveResult>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "Array<SaveResult>");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param xZuoraWSDLVersion Zuora WSDL version number. 
     */
    public async actionPOSTdelete (deleteRequest: ProxyActiondeleteRequest, rejectUnknownFields?: boolean, zuoraEntityIds?: string, zuoraTrackId?: string, xZuoraWSDLVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Array<DeleteResult>;  }> {
        const localVarPath = this.basePath + '/v1/action/delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (deleteRequest === null || deleteRequest === undefined) {
            throw new Error('Required parameter deleteRequest was null or undefined when calling actionPOSTdelete.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(deleteRequest, "ProxyActiondeleteRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: Array<DeleteResult>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "Array<DeleteResult>");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param xZuoraWSDLVersion Zuora WSDL version number. 
     */
    public async actionPOSTexecute (executeRequest: ProxyActionexecuteRequest, rejectUnknownFields?: boolean, zuoraEntityIds?: string, zuoraTrackId?: string, xZuoraWSDLVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Array<ExecuteResult>;  }> {
        const localVarPath = this.basePath + '/v1/action/execute';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (executeRequest === null || executeRequest === undefined) {
            throw new Error('Required parameter executeRequest was null or undefined when calling actionPOSTexecute.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(executeRequest, "ProxyActionexecuteRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: Array<ExecuteResult>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "Array<ExecuteResult>");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param xZuoraWSDLVersion Zuora WSDL version number. 
     */
    public async actionPOSTgenerate (generateRequest: ProxyActiongenerateRequest, rejectUnknownFields?: boolean, zuoraEntityIds?: string, zuoraTrackId?: string, xZuoraWSDLVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Array<SaveResult>;  }> {
        const localVarPath = this.basePath + '/v1/action/generate';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (generateRequest === null || generateRequest === undefined) {
            throw new Error('Required parameter generateRequest was null or undefined when calling actionPOSTgenerate.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(generateRequest, "ProxyActiongenerateRequest")
        };
     ...
     * @param xZuoraWSDLVersion Zuora WSDL version number. 
     */
    public async actionPOSTquery (queryRequest: ProxyActionqueryRequest, rejectUnknownFields?: boolean, zuoraEntityIds?: string, zuoraTrackId?: string, xZuoraWSDLVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ProxyActionqueryResponse;  }> {
        const localVarPath = this.basePath + '/v1/action/query';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (queryRequest === null || queryRequest === undefined) {
            throw new Error('Required parameter queryRequest was null or undefined when calling actionPOSTquery.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(queryRequest, "ProxyActionqueryRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: ProxyActionqueryResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ProxyActionqueryResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param xZuoraWSDLVersion Zuora WSDL version number. 
     */
    public async actionPOSTqueryMore (queryMoreRequest: ProxyActionqueryMoreRequest, rejectUnknownFields?: boolean, zuoraEntityIds?: string, zuoraTrackId?: string, xZuoraWSDLVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ProxyActionqueryMoreResponse;  }> {
        const localVarPath = this.basePath + '/v1/action/queryMore';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json', ];
        // give precedence to 'application/json'
        ...
        if (queryMoreRequest === null || queryMoreRequest === undefined) {
            throw new Error('Required parameter queryMoreRequest was null or undefined when calling actionPOSTqueryMore.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(queryMoreRequest, "ProxyActionqueryMoreRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: ProxyActionqueryMoreResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ProxyActionqueryMoreResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param xZuoraWSDLVersion Zuora WSDL version number. 
     */
    public async actionPOSTsubscribe (subscribeRequest: ProxyActionsubscribeRequest, rejectUnknownFields?: boolean, zuoraEntityIds?: string, zuoraTrackId?: string, xZuoraWSDLVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Array<SubscribeResult>;  }> {
        const localVarPath = this.basePath + '/v1/action/subscribe';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (subscribeRequest === null || subscribeRequest === undefined) {
            throw new Error('Required parameter subscribeRequest was null or undefined when calling actionPOSTsubscribe.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(subscribeRequest, "ProxyActionsubscribeRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: Array<SubscribeResult>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "Array<SubscribeResult>");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param xZuoraWSDLVersion Zuora WSDL version number. 
     */
    public async actionPOSTupdate (updateRequest: ProxyActionupdateRequest, rejectUnknownFields?: boolean, zuoraEntityIds?: string, zuoraTrackId?: string, xZuoraWSDLVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Array<SaveResult>;  }> {
        const localVarPath = this.basePath + '/v1/action/update';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (updateRequest === null || updateRequest === undefined) {
            throw new Error('Required parameter updateRequest was null or undefined when calling actionPOSTupdate.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateRequest, "ProxyActionupdateRequest")
        };
