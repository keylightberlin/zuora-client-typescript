...
import { CustomObjectDefinition } from '../model/customObjectDefinition';
import { GETAllCustomObjectDefinitionsInNamespaceResponse } from '../model/gETAllCustomObjectDefinitionsInNamespaceResponse';
import { MigrationUpdateCustomObjectDefinitionsRequest } from '../model/migrationUpdateCustomObjectDefinitionsRequest';
import { MigrationUpdateCustomObjectDefinitionsResponse } from '../model/migrationUpdateCustomObjectDefinitionsResponse';
import { PostCustomObjectDefinitionRequest } from '../model/postCustomObjectDefinitionRequest';
...
export enum CustomObjectDefinitionsApiApiKeys {
}

export class CustomObjectDefinitionsApi {
    ...
    public setApiKey(key: CustomObjectDefinitionsApiApiKeys, value: string) {
        (this.authentications as any)[CustomObjectDefinitionsApiApiKeys[key]].apiKey = value;
    }
    ...
    /**
     * Delete the custom object definition for the provided type.  **Note:** A custom object definition can only be deleted if no record of this custom object type exists. 
     ...
     */
    public async deleteCustomObjectDefinitionByType (authorization: string, object: string, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: string;  }> {
        const localVarPath = this.basePath + '/objects/definitions/default/{object}'
        ...
        if (authorization === null || authorization === undefined) {
            throw new Error('Required parameter authorization was null or undefined when calling deleteCustomObjectDefinitionByType.');
        }

        // verify required parameter 'object' is not null or undefined
        if (object === null || object === undefined) {
            throw new Error('Required parameter object was null or undefined when calling deleteCustomObjectDefinitionByType.');
        }
     ...
     */
    public async gETAllCustomObjectDefinitionsInNamespace (authorization: string, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, select?: 'type', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETAllCustomObjectDefinitionsInNamespaceResponse;  }> {
        const localVarPath = this.basePath + '/objects/definitions/default';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'authorization' is not null or undefined
        if (authorization === null || authorization === undefined) {
            throw new Error('Required parameter authorization was null or undefined when calling gETAllCustomObjectDefinitionsInNamespace.');
        }

        if (select !== undefined) {
            localVarQueryParameters['select'] = ObjectSerializer.serialize(select, "'type'");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETAllCustomObjectDefinitionsInNamespaceResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETAllCustomObjectDefinitionsInNamespaceResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraVersion API version that determines the response schema. The default version is used if this parameter is not included. Specify &#x60;Zuora-Version&#x60; in the request header if you expect a specific response schema.
     */
    public async gETCustomObjectDefinitionByType (authorization: string, object: string, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CustomObjectDefinition;  }> {
        const localVarPath = this.basePath + '/objects/definitions/default/{object}'
            .replace('{' + 'object' + '}', encodeURIComponent(String(object)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'authorization' is not null or undefined
        if (authorization === null || authorization === undefined) {
            throw new Error('Required parameter authorization was null or undefined when calling gETCustomObjectDefinitionByType.');
        }

        // verify required parameter 'object' is not null or undefined
        if (object === null || object === undefined) {
            throw new Error('Required parameter object was null or undefined when calling gETCustomObjectDefinitionByType.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: CustomObjectDefinition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CustomObjectDefinition");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
    ...
    public async pOSTCustomObjectDefinition (authorization: string, customObjectDefinition: PostCustomObjectDefinitionRequest, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CustomObjectDefinition;  }> {
        ...
        // verify required parameter 'authorization' is not null or undefined
        if (authorization === null || authorization === undefined) {
            throw new Error('Required parameter authorization was null or undefined when calling pOSTCustomObjectDefinition.');
        }

        // verify required parameter 'customObjectDefinition' is not null or undefined
        if (customObjectDefinition === null || customObjectDefinition === undefined) {
            throw new Error('Required parameter customObjectDefinition was null or undefined when calling pOSTCustomObjectDefinition.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(customObjectDefinition, "PostCustomObjectDefinitionRequest")
        };
    ...
    public async pOSTUpdateCustomObjectDefinition (authorization: string, migration: MigrationUpdateCustomObjectDefinitionsRequest, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: MigrationUpdateCustomObjectDefinitionsResponse;  }> {
        ...
        // verify required parameter 'authorization' is not null or undefined
        if (authorization === null || authorization === undefined) {
            throw new Error('Required parameter authorization was null or undefined when calling pOSTUpdateCustomObjectDefinition.');
        }

        // verify required parameter 'migration' is not null or undefined
        if (migration === null || migration === undefined) {
            throw new Error('Required parameter migration was null or undefined when calling pOSTUpdateCustomObjectDefinition.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(migration, "MigrationUpdateCustomObjectDefinitionsRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: MigrationUpdateCustomObjectDefinitionsResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "MigrationUpdateCustomObjectDefinitionsResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
