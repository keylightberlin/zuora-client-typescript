...
import { GETSubscriptionTypeWithSuccess } from '../model/gETSubscriptionTypeWithSuccess';
import { GETSubscriptionWrapper } from '../model/gETSubscriptionWrapper';
import { POSTSubscriptionCancellationResponseType } from '../model/pOSTSubscriptionCancellationResponseType';
import { POSTSubscriptionCancellationType } from '../model/pOSTSubscriptionCancellationType';
import { POSTSubscriptionPreviewResponseType } from '../model/pOSTSubscriptionPreviewResponseType';
import { POSTSubscriptionPreviewType } from '../model/pOSTSubscriptionPreviewType';
import { POSTSubscriptionResponseType } from '../model/pOSTSubscriptionResponseType';
import { POSTSubscriptionType } from '../model/pOSTSubscriptionType';
import { PUTRenewSubscriptionResponseType } from '../model/pUTRenewSubscriptionResponseType';
import { PUTRenewSubscriptionType } from '../model/pUTRenewSubscriptionType';
import { PUTSubscriptionPatchRequestType } from '../model/pUTSubscriptionPatchRequestType';
import { PUTSubscriptionResponseType } from '../model/pUTSubscriptionResponseType';
import { PUTSubscriptionResumeResponseType } from '../model/pUTSubscriptionResumeResponseType';
import { PUTSubscriptionResumeType } from '../model/pUTSubscriptionResumeType';
import { PUTSubscriptionSuspendResponseType } from '../model/pUTSubscriptionSuspendResponseType';
import { PUTSubscriptionSuspendType } from '../model/pUTSubscriptionSuspendType';
import { PUTSubscriptionType } from '../model/pUTSubscriptionType';
...
import { ProxyGetSubscription } from '../model/proxyGetSubscription';
import { ProxyModifySubscription } from '../model/proxyModifySubscription';
...
export class SubscriptionsApi {
     ...
     */
    public async gETSubscriptionsByAccount (accountKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, chargeDetail?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETSubscriptionWrapper;  }> {
        const localVarPath = this.basePath + '/v1/subscriptions/accounts/{account-key}'
        ...
        if (accountKey === null || accountKey === undefined) {
            throw new Error('Required parameter accountKey was null or undefined when calling gETSubscriptionsByAccount.');
        }
        ...
        if (chargeDetail !== undefined) {
            localVarQueryParameters['charge-detail'] = ObjectSerializer.serialize(chargeDetail, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETSubscriptionWrapper;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETSubscriptionWrapper");
     ...
     */
    public async gETSubscriptionsByKey (subscriptionKey: string, zuoraTrackId?: string, zuoraEntityIds?: string, chargeDetail?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETSubscriptionTypeWithSuccess;  }> {
        const localVarPath = this.basePath + '/v1/subscriptions/{subscription-key}'
        ...
        if (subscriptionKey === null || subscriptionKey === undefined) {
            throw new Error('Required parameter subscriptionKey was null or undefined when calling gETSubscriptionsByKey.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETSubscriptionTypeWithSuccess;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETSubscriptionTypeWithSuccess");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param chargeDetail  The segmented rate plan charges. When an amendment results in a change to a charge, Zuora creates a segmented rate plan charge. Use this field to track segment charges.  Possible values are:   * __last-segment__: (Default) The last rate plan charge on the subscription. The last rate plan charge is the last one in the order of time on the subscription rather than the most recent changed charge on the subscription.  * __current-segment__: The segmented charge that is active on today’s date (effectiveStartDate &lt;&#x3D; today’s date &lt; effectiveEndDate).    * __all-segments__: All the segmented charges. The &#x60;chargeSegments&#x60; field is returned in the response. The &#x60;chargeSegments&#x60; field contains an array of the charge information for all the charge segments.   * __specific-segment&amp;as-of-date&#x3D;date__: The segmented charge that is active on a date you specified (effectiveStartDate &lt;&#x3D; specific date &lt; effectiveEndDate). The format of the date is yyyy-mm-dd. 
     */
    public async gETSubscriptionsByKeyAndVersion (subscriptionKey: string, version: string, zuoraTrackId?: string, zuoraEntityIds?: string, chargeDetail?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETSubscriptionTypeWithSuccess;  }> {
        const localVarPath = this.basePath + '/v1/subscriptions/{subscription-key}/versions/{version}'
            .replace('{' + 'subscription-key' + '}', encodeURIComponent(String(subscriptionKey)))
        ...
        // verify required parameter 'subscriptionKey' is not null or undefined
        if (subscriptionKey === null || subscriptionKey === undefined) {
            throw new Error('Required parameter subscriptionKey was null or undefined when calling gETSubscriptionsByKeyAndVersion.');
        }

        // verify required parameter 'version' is not null or undefined
        if (version === null || version === undefined) {
            throw new Error('Required parameter version was null or undefined when calling gETSubscriptionsByKeyAndVersion.');
        }
     ...
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async objectDELETESubscription (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ProxyDeleteResponse;  }> {
        const localVarPath = this.basePath + '/v1/object/subscription/{id}'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling objectDELETESubscription.');
        }
     ...
     */
    public async objectGETSubscription (id: string, zuoraEntityIds?: string, zuoraTrackId?: string, fields?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ProxyGetSubscription;  }> {
        const localVarPath = this.basePath + '/v1/object/subscription/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling objectGETSubscription.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: ProxyGetSubscription;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ProxyGetSubscription");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async objectPUTSubscription (id: string, modifyRequest: ProxyModifySubscription, rejectUnknownFields?: boolean, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ProxyCreateOrModifyResponse;  }> {
        const localVarPath = this.basePath + '/v1/object/subscription/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling objectPUTSubscription.');
        }

        // verify required parameter 'modifyRequest' is not null or undefined
        if (modifyRequest === null || modifyRequest === undefined) {
            throw new Error('Required parameter modifyRequest was null or undefined when calling objectPUTSubscription.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(modifyRequest, "ProxyModifySubscription")
        };
     ...
     */
    public async pOSTPreviewSubscription (request: POSTSubscriptionPreviewType, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: POSTSubscriptionPreviewResponseType;  }> {
        const localVarPath = this.basePath + '/v1/subscriptions/preview';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pOSTPreviewSubscription.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "POSTSubscriptionPreviewType")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: POSTSubscriptionPreviewResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "POSTSubscriptionPreviewResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async pOSTSubscription (request: POSTSubscriptionType, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: POSTSubscriptionResponseType;  }> {
        ...
        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pOSTSubscription.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "POSTSubscriptionType")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: POSTSubscriptionResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "POSTSubscriptionResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraVersion The minor version of the Zuora REST API.   You only need to set this parameter if you use the following fields: * invoice * collect * runBilling * targetDate  
     */
    public async pUTCancelSubscription (subscriptionKey: string, request: POSTSubscriptionCancellationType, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: POSTSubscriptionCancellationResponseType;  }> {
        const localVarPath = this.basePath + '/v1/subscriptions/{subscription-key}/cancel'
            .replace('{' + 'subscription-key' + '}', encodeURIComponent(String(subscriptionKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'subscriptionKey' is not null or undefined
        if (subscriptionKey === null || subscriptionKey === undefined) {
            throw new Error('Required parameter subscriptionKey was null or undefined when calling pUTCancelSubscription.');
        }

        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pUTCancelSubscription.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "POSTSubscriptionCancellationType")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: POSTSubscriptionCancellationResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "POSTSubscriptionCancellationResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraVersion The minor version of the Zuora REST API.   You only need to set this parameter if you use the following fields: * invoice * collect * runBilling * targetDate  
     */
    public async pUTRenewSubscription (subscriptionKey: string, request: PUTRenewSubscriptionType, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: PUTRenewSubscriptionResponseType;  }> {
        const localVarPath = this.basePath + '/v1/subscriptions/{subscription-key}/renew'
            .replace('{' + 'subscription-key' + '}', encodeURIComponent(String(subscriptionKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'subscriptionKey' is not null or undefined
        if (subscriptionKey === null || subscriptionKey === undefined) {
            throw new Error('Required parameter subscriptionKey was null or undefined when calling pUTRenewSubscription.');
        }

        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pUTRenewSubscription.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "PUTRenewSubscriptionType")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: PUTRenewSubscriptionResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PUTRenewSubscriptionResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraVersion The minor version of the Zuora REST API.   You only need to set this parameter if you use the following fields: * invoice * collect * runBilling * targetDate 
     */
    public async pUTResumeSubscription (subscriptionKey: string, request: PUTSubscriptionResumeType, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: PUTSubscriptionResumeResponseType;  }> {
        const localVarPath = this.basePath + '/v1/subscriptions/{subscription-key}/resume'
            .replace('{' + 'subscription-key' + '}', encodeURIComponent(String(subscriptionKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'subscriptionKey' is not null or undefined
        if (subscriptionKey === null || subscriptionKey === undefined) {
            throw new Error('Required parameter subscriptionKey was null or undefined when calling pUTResumeSubscription.');
        }

        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pUTResumeSubscription.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "PUTSubscriptionResumeType")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: PUTSubscriptionResumeResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PUTSubscriptionResumeResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async pUTSubscription (subscriptionKey: string, request: PUTSubscriptionType, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: PUTSubscriptionResponseType;  }> {
        const localVarPath = this.basePath + '/v1/subscriptions/{subscription-key}'
            .replace('{' + 'subscription-key' + '}', encodeURIComponent(String(subscriptionKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'subscriptionKey' is not null or undefined
        if (subscriptionKey === null || subscriptionKey === undefined) {
            throw new Error('Required parameter subscriptionKey was null or undefined when calling pUTSubscription.');
        }

        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pUTSubscription.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "PUTSubscriptionType")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: PUTSubscriptionResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PUTSubscriptionResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraVersion The minor version of the Zuora REST API.   You only need to set this parameter if you use the following fields: * invoice * collect * runBilling * targetDate 
     */
    public async pUTSuspendSubscription (subscriptionKey: string, request: PUTSubscriptionSuspendType, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: PUTSubscriptionSuspendResponseType;  }> {
        const localVarPath = this.basePath + '/v1/subscriptions/{subscription-key}/suspend'
            .replace('{' + 'subscription-key' + '}', encodeURIComponent(String(subscriptionKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'subscriptionKey' is not null or undefined
        if (subscriptionKey === null || subscriptionKey === undefined) {
            throw new Error('Required parameter subscriptionKey was null or undefined when calling pUTSuspendSubscription.');
        }

        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pUTSuspendSubscription.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "PUTSubscriptionSuspendType")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: PUTSubscriptionSuspendResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PUTSubscriptionSuspendResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param version The subscription version to be updated.
     * @param body 
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTUpdateSubscriptionCustomFieldsOfASpecifiedVersion (subscriptionNumber: string, version: string, body: PUTSubscriptionPatchRequestType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/subscriptions/{subscriptionNumber}/versions/{version}/customFields'
        ...
        if (subscriptionNumber === null || subscriptionNumber === undefined) {
            throw new Error('Required parameter subscriptionNumber was null or undefined when calling pUTUpdateSubscriptionCustomFieldsOfASpecifiedVersion.');
        }

        // verify required parameter 'version' is not null or undefined
        if (version === null || version === undefined) {
            throw new Error('Required parameter version was null or undefined when calling pUTUpdateSubscriptionCustomFieldsOfASpecifiedVersion.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pUTUpdateSubscriptionCustomFieldsOfASpecifiedVersion.');
        }
