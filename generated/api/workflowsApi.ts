...
import { DeleteWorkflowError } from '../model/deleteWorkflowError';
import { DeleteWorkflowSuccess } from '../model/deleteWorkflowSuccess';
import { GetWorkflowResponse } from '../model/getWorkflowResponse';
import { GetWorkflowsResponse } from '../model/getWorkflowsResponse';
import { InlineObject } from '../model/inlineObject';
import { InlineResponse2005 } from '../model/inlineResponse2005';
import { InlineResponse400 } from '../model/inlineResponse400';
import { InlineResponse406 } from '../model/inlineResponse406';
import { PutTasksRequest } from '../model/putTasksRequest';
import { Task } from '../model/task';
import { TasksResponse } from '../model/tasksResponse';
import { UsagesResponse } from '../model/usagesResponse';
...
export class WorkflowsApi {
     ...
     * @param workflowId The unique ID of a workflow. For example, 19080. 
     ...
     */
    public async dELETEWorkflow (authorization: string, workflowId: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: DeleteWorkflowSuccess;  }> {
        const localVarPath = this.basePath + '/workflows/{workflow_id}'
        ...
        if (authorization === null || authorization === undefined) {
            throw new Error('Required parameter authorization was null or undefined when calling dELETEWorkflow.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: DeleteWorkflowSuccess;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "DeleteWorkflowSuccess");
     ...
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async gETWorkflow (authorization: string, workflowId: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GetWorkflowResponse;  }> {
        const localVarPath = this.basePath + '/workflows/{workflow_id}'
            .replace('{' + 'workflow_id' + '}', encodeURIComponent(String(workflowId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'authorization' is not null or undefined
        if (authorization === null || authorization === undefined) {
            throw new Error('Required parameter authorization was null or undefined when calling gETWorkflow.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GetWorkflowResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async gETWorkflowExport (workflowId: number, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: InlineResponse2005;  }> {
        const localVarPath = this.basePath + '/workflows/{workflow_id}/export'
            .replace('{' + 'workflow_id' + '}', encodeURIComponent(String(workflowId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'workflowId' is not null or undefined
        if (workflowId === null || workflowId === undefined) {
            throw new Error('Required parameter workflowId was null or undefined when calling gETWorkflowExport.');
        }
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param calloutTrigger If set to true, the operation retrieves workflows that have the callout trigger enabled. If set to false, the operation retrieves workflows that have the callout trigger disabled. If not specified, the operation will not use this filter. 
     ...
     * @param ondemandTrigger If set to true, the operation retrieves workflows that have the ondemand trigger enabled. If set to false, the operation retrieves workflows that have the ondemand trigger disabled. If not specified, the operation will not use this filter. 
     * @param scheduledTrigger If set to true, the operation retrieves workflows that have the scheduled trigger enabled. If set to false, the operation retrieves workflows that have the scheduled trigger disabled. If not specfied, the operation will not use this filter. 
     * @param page If you want to retrieve only the workflows on a specific page, you can specify the &#x60;page&#x60; number in the query. 
     * @param pageLength The number of workflows shown in a single call. If the &#x60;page&#x60; parameter is not specified, the operation will return only the first page of results. If there are multiple pages of results, use it with the &#x60;page&#x60; parameter to get the results on subsequent pages. 
     */
    public async gETWorkflows (authorization: string, zuoraEntityIds?: string, zuoraTrackId?: string, calloutTrigger?: boolean, interval?: string, name?: string, ondemandTrigger?: boolean, scheduledTrigger?: boolean, page?: number, pageLength?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GetWorkflowsResponse;  }> {
        const localVarPath = this.basePath + '/workflows';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'authorization' is not null or undefined
        if (authorization === null || authorization === undefined) {
            throw new Error('Required parameter authorization was null or undefined when calling gETWorkflows.');
        }

        if (calloutTrigger !== undefined) {
            localVarQueryParameters['callout_trigger'] = ObjectSerializer.serialize(calloutTrigger, "boolean");
        }
        ...
        if (ondemandTrigger !== undefined) {
            localVarQueryParameters['ondemand_trigger'] = ObjectSerializer.serialize(ondemandTrigger, "boolean");
        }

        if (scheduledTrigger !== undefined) {
            localVarQueryParameters['scheduled_trigger'] = ObjectSerializer.serialize(scheduledTrigger, "boolean");
        }
        ...
        if (pageLength !== undefined) {
            localVarQueryParameters['page_length'] = ObjectSerializer.serialize(pageLength, "number");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GetWorkflowsResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GetWorkflowsResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async gETWorkflowsTask (authorization: string, taskId: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Task;  }> {
        const localVarPath = this.basePath + '/workflows/tasks/{task_id}'
        ...
        // verify required parameter 'authorization' is not null or undefined
        if (authorization === null || authorization === undefined) {
            throw new Error('Required parameter authorization was null or undefined when calling gETWorkflowsTask.');
        }

        // verify required parameter 'taskId' is not null or undefined
        if (taskId === null || taskId === undefined) {
            throw new Error('Required parameter taskId was null or undefined when calling gETWorkflowsTask.');
        }
     ...
     * @param actionType If specified, the operation retrieves tasks that is the specified type. 
     * @param object If specified, the operation retrieves tasks with the specified object. 
     * @param objectId If specified, the operation retrieves tasks with the specified object id. 
     * @param callType If specified, the operation retrieves tasks with the specified api call type used. 
     * @param workflowId If specified, the operation retrieves tasks that for the specified workflow id. 
     * @param tags If specified, the operation retrieves tasks that with the specified filter tags. 
     * @param page If you want to retrieve only the workflows on a specific page, you can specify the &#x60;page&#x60; number in the query. 
     * @param pageLength The number of workflows shown in a single call. If the &#x60;page&#x60; parameter is not specified, the operation will return only the first page of results. If there are multiple pages of results, use it with the &#x60;page&#x60; parameter to get the results on subsequent pages. 
     */
    public async gETWorkflowsTasks (authorization: string, zuoraEntityIds?: string, zuoraTrackId?: string, id?: string, name?: string, instance?: boolean, actionType?: string, object?: string, objectId?: string, callType?: string, workflowId?: string, tags?: string, page?: number, pageLength?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: TasksResponse;  }> {
        const localVarPath = this.basePath + '/workflows/tasks';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'authorization' is not null or undefined
        if (authorization === null || authorization === undefined) {
            throw new Error('Required parameter authorization was null or undefined when calling gETWorkflowsTasks.');
        }
        ...
        if (instance !== undefined) {
            localVarQueryParameters['instance'] = ObjectSerializer.serialize(instance, "boolean");
        }

        if (actionType !== undefined) {
            localVarQueryParameters['action_type'] = ObjectSerializer.serialize(actionType, "string");
        }
        ...
        if (objectId !== undefined) {
            localVarQueryParameters['object_id'] = ObjectSerializer.serialize(objectId, "string");
        }

        if (callType !== undefined) {
            localVarQueryParameters['call_type'] = ObjectSerializer.serialize(callType, "string");
        }

        if (workflowId !== undefined) {
            localVarQueryParameters['workflow_id'] = ObjectSerializer.serialize(workflowId, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: TasksResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "TasksResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param authorization &#x60;Bearer {token}&#x60; for a valid OAuth token. 
     * @param startDate The start date of the usage data that you want to get. For example, 2019-01-01. 
     * @param endDate The end date of the usage data that you want to get. For example, 2019-12-31. 
     * @param metrics The type of metric that you want to get. Currently, only &#x60;taskCount&#x60; is supported. &#x60;taskCount&#x60; is the amount of task runs. 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async gETWorkflowsUsages (authorization: string, startDate: string, endDate: string, metrics: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: UsagesResponse;  }> {
        const localVarPath = this.basePath + '/workflows/metrics.json';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'authorization' is not null or undefined
        if (authorization === null || authorization === undefined) {
            throw new Error('Required parameter authorization was null or undefined when calling gETWorkflowsUsages.');
        }

        // verify required parameter 'startDate' is not null or undefined
        if (startDate === null || startDate === undefined) {
            throw new Error('Required parameter startDate was null or undefined when calling gETWorkflowsUsages.');
        }

        // verify required parameter 'endDate' is not null or undefined
        if (endDate === null || endDate === undefined) {
            throw new Error('Required parameter endDate was null or undefined when calling gETWorkflowsUsages.');
        }

        // verify required parameter 'metrics' is not null or undefined
        if (metrics === null || metrics === undefined) {
            throw new Error('Required parameter metrics was null or undefined when calling gETWorkflowsUsages.');
        }
        ...
        if (metrics !== undefined) {
            localVarQueryParameters['metrics'] = ObjectSerializer.serialize(metrics, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: UsagesResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "UsagesResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
    ...
    /**
     * Run a specified workflow. In the request body, you can include parameters that you want to pass to the workflow. For the parameters to be recognized and picked up by tasks in the workflow, you need to define the parameters first.   To learn about how to define parameters, see [Configure the settings of a workflow](https://knowledgecenter.zuora.com/CE_Workflow/Using_Workflow/B_Configure_a_Workflow). 
     * @summary Run a workflow
     * @param authorization &#x60;Bearer {token}&#x60; for a valid OAuth token. 
     * @param workflowId The ID of the workflow you want to run.
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param inputparameters Include parameters you want to pass to the workflow.
     */
    public async pOSTRunWorkflow (authorization: string, workflowId: number, zuoraEntityIds?: string, zuoraTrackId?: string, inputparameters?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: WorkflowInstance;  }> {
        const localVarPath = this.basePath + '/workflows/{workflow_id}/run'
            .replace('{' + 'workflow_id' + '}', encodeURIComponent(String(workflowId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'authorization' is not null or undefined
        if (authorization === null || authorization === undefined) {
            throw new Error('Required parameter authorization was null or undefined when calling pOSTRunWorkflow.');
        }

        // verify required parameter 'workflowId' is not null or undefined
        if (workflowId === null || workflowId === undefined) {
            throw new Error('Required parameter workflowId was null or undefined when calling pOSTRunWorkflow.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(inputparameters, "object")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: WorkflowInstance;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "WorkflowInstance");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param request 
     */
    public async pOSTWorkflowImport (zuoraTrackId?: string, request?: InlineObject, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Workflow;  }> {
        const localVarPath = this.basePath + '/workflows/import';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
     ...
     * @param updateRequest 
     */
    public async pUTWorkflowsTasksUpdate (authorization: string, zuoraEntityIds?: string, zuoraTrackId?: string, updateRequest?: PutTasksRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: TasksResponse;  }> {
        const localVarPath = this.basePath + '/workflows/tasks/batch_update';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'authorization' is not null or undefined
        if (authorization === null || authorization === undefined) {
            throw new Error('Required parameter authorization was null or undefined when calling pUTWorkflowsTasksUpdate.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateRequest, "PutTasksRequest")
        };
