...
import { GETDocumentPropertiesResponseType } from '../model/gETDocumentPropertiesResponseType';
import { POSTDocumentPropertiesType } from '../model/pOSTDocumentPropertiesType';
import { PUTDocumentPropertiesType } from '../model/pUTDocumentPropertiesType';
...
export enum DocumentPropertiesApiApiKeys {
}

export class DocumentPropertiesApi {
    ...
    public setApiKey(key: DocumentPropertiesApiApiKeys, value: string) {
        (this.authentications as any)[DocumentPropertiesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param documentPropertiesId The unique ID of document properties. For example, 402892c74c9193cd014c96bbe7c101f9. 
     ...
     */
    public async dELETEDocumentProperties (documentPropertiesId: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/document-properties/{documentPropertiesId}'
            .replace('{' + 'documentPropertiesId' + '}', encodeURIComponent(String(documentPropertiesId)));
        ...
        // verify required parameter 'documentPropertiesId' is not null or undefined
        if (documentPropertiesId === null || documentPropertiesId === undefined) {
            throw new Error('Required parameter documentPropertiesId was null or undefined when calling dELETEDocumentProperties.');
        }
     ...
     * @param documentType The type of the billing document.  
     * @param documentId The unique ID of document properties to be retrieved. For example, 402892c74c9193cd014c96bbe7c101f9. 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async gETDocumentProperies (documentType: 'Invoice' | 'CreditMemo' | 'DebitMemo', documentId: string, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETDocumentPropertiesResponseType;  }> {
        const localVarPath = this.basePath + '/v1/document-properties/{documentType}/{documentId}'
        ...
        if (documentType === null || documentType === undefined) {
            throw new Error('Required parameter documentType was null or undefined when calling gETDocumentProperies.');
        }

        // verify required parameter 'documentId' is not null or undefined
        if (documentId === null || documentId === undefined) {
            throw new Error('Required parameter documentId was null or undefined when calling gETDocumentProperies.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETDocumentPropertiesResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETDocumentPropertiesResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async pOSTDocumentProperties (request: POSTDocumentPropertiesType, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETDocumentPropertiesResponseType;  }> {
        ...
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pOSTDocumentProperties.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "POSTDocumentPropertiesType")
        };
     ...
     * @param documentPropertiesId The unique ID of document properties to be updated. For example, 402892c74c9193cd014c96bbe7c101f9. 
     * @param request 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async pUTDocumentProperties (documentPropertiesId: string, request: PUTDocumentPropertiesType, zuoraEntityIds?: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETDocumentPropertiesResponseType;  }> {
        const localVarPath = this.basePath + '/v1/document-properties/{documentPropertiesId}'
            .replace('{' + 'documentPropertiesId' + '}', encodeURIComponent(String(documentPropertiesId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'documentPropertiesId' is not null or undefined
        if (documentPropertiesId === null || documentPropertiesId === undefined) {
            throw new Error('Required parameter documentPropertiesId was null or undefined when calling pUTDocumentProperties.');
        }

        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pUTDocumentProperties.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "PUTDocumentPropertiesType")
        };
