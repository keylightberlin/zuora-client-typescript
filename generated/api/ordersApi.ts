...
import { GetAllOrdersResponseType } from '../model/getAllOrdersResponseType';
import { GetOrderResponse } from '../model/getOrderResponse';
import { GetOrderResponseForEvergreen } from '../model/getOrderResponseForEvergreen';
import { GetOrdersResponse } from '../model/getOrdersResponse';
import { GetSubscriptionTermInfoResponseType } from '../model/getSubscriptionTermInfoResponseType';
import { InlineResponse2004 } from '../model/inlineResponse2004';
import { InlineResponse202 } from '../model/inlineResponse202';
import { POSTOrderPreviewRequestType } from '../model/pOSTOrderPreviewRequestType';
import { POSTOrderRequestType } from '../model/pOSTOrderRequestType';
import { PUTOrderActionTriggerDatesRequestType } from '../model/pUTOrderActionTriggerDatesRequestType';
import { PUTOrderPatchRequestType } from '../model/pUTOrderPatchRequestType';
import { PUTOrderTriggerDatesResponseType } from '../model/pUTOrderTriggerDatesResponseType';
import { PUTSubscriptionPatchRequestType } from '../model/pUTSubscriptionPatchRequestType';
import { PostOrderPreviewResponseType } from '../model/postOrderPreviewResponseType';
import { PostOrderResponseType } from '../model/postOrderResponseType';
...
export class OrdersApi {
     ...
     * @param orderNumber The number of the order to be deleted.
     ...
     */
    public async dELETEOrder (orderNumber: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/orders/{orderNumber}'
        ...
        if (orderNumber === null || orderNumber === undefined) {
            throw new Error('Required parameter orderNumber was null or undefined when calling dELETEOrder.');
        }
     ...
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param page The page number of the orders retrieved.  
     * @param pageSize Number of rows returned per page. 
     * @param dateFilterOption The date type to filter on. This field value can be orderDate or updatedDate. Default is orderDate. 
     * @param startDate The result will only contain the orders with the date of dateFilterOption later than or equal to this date. 
     * @param endDate The result will only contains orders with the date of dateFilterOption earlier than or equal to this date. 
     */
    public async gETAllOrders (zuoraTrackId?: string, zuoraEntityIds?: string, page?: number, pageSize?: number, dateFilterOption?: string, startDate?: string, endDate?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GetAllOrdersResponseType;  }> {
        ...
        if (dateFilterOption !== undefined) {
            localVarQueryParameters['dateFilterOption'] = ObjectSerializer.serialize(dateFilterOption, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GetAllOrdersResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GetAllOrdersResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param jobId UUID of the asynchronous job created by an asynchronous API operation.
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     */
    public async gETJobStatusAndResponse (jobId: string, zuoraTrackId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: InlineResponse2004;  }> {
        const localVarPath = this.basePath + '/v1/async-jobs/{jobId}'
        ...
        if (jobId === null || jobId === undefined) {
            throw new Error('Required parameter jobId was null or undefined when calling gETJobStatusAndResponse.');
        }
     ...
     * @param orderNumber The order number to be retrieved.
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async gETOrder (orderNumber: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GetOrderResponse;  }> {
        const localVarPath = this.basePath + '/v1/orders/{orderNumber}'
            .replace('{' + 'orderNumber' + '}', encodeURIComponent(String(orderNumber)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'orderNumber' is not null or undefined
        if (orderNumber === null || orderNumber === undefined) {
            throw new Error('Required parameter orderNumber was null or undefined when calling gETOrder.');
        }
     ...
     * @param subscriptionNumber The subscription number you want to get the metrics for. 
     * @param startDate The start date of the date range for which you want to get the metrics. The date must be in yyyy-mm-dd format. For example, 2017-12-03. 
     * @param endDate The end date of the date range for which you want to get the metrics. The date must be in yyyy-mm-dd format. For example, 2017-12-03. 
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async gETOrderMetricsforEvergreenSubscription (orderNumber: string, subscriptionNumber: string, startDate: string, endDate: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GetOrderResponseForEvergreen;  }> {
        const localVarPath = this.basePath + '/v1/orders/{orderNumber}/evergreenMetrics/{subscriptionNumber}'
            .replace('{' + 'orderNumber' + '}', encodeURIComponent(String(orderNumber)))
        ...
        // verify required parameter 'orderNumber' is not null or undefined
        if (orderNumber === null || orderNumber === undefined) {
            throw new Error('Required parameter orderNumber was null or undefined when calling gETOrderMetricsforEvergreenSubscription.');
        }
        ...
        if (subscriptionNumber === null || subscriptionNumber === undefined) {
            throw new Error('Required parameter subscriptionNumber was null or undefined when calling gETOrderMetricsforEvergreenSubscription.');
        }

        // verify required parameter 'startDate' is not null or undefined
        if (startDate === null || startDate === undefined) {
            throw new Error('Required parameter startDate was null or undefined when calling gETOrderMetricsforEvergreenSubscription.');
        }

        // verify required parameter 'endDate' is not null or undefined
        if (endDate === null || endDate === undefined) {
            throw new Error('Required parameter endDate was null or undefined when calling gETOrderMetricsforEvergreenSubscription.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GetOrderResponseForEvergreen;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GetOrderResponseForEvergreen");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param accountNumber The invoice owner account number.
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param page The page number of the orders retrieved. The default is 1. 
     * @param pageSize Number of rows returned per page. 
     * @param dateFilterOption The date type to filter on. This field value can be orderDate or updatedDate. Default is orderDate. 
     * @param startDate The result will only contain the orders with the date of dateFilterOption later than or equal to this date. 
     * @param endDate The result will only contain the orders with the date of dateFilterOption earlier than or equal to this date. 
     */
    public async gETOrdersByInvoiceOwner (accountNumber: string, zuoraTrackId?: string, zuoraEntityIds?: string, page?: number, pageSize?: number, dateFilterOption?: string, startDate?: string, endDate?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GetOrdersResponse;  }> {
        const localVarPath = this.basePath + '/v1/orders/invoiceOwner/{accountNumber}'
        ...
        if (accountNumber === null || accountNumber === undefined) {
            throw new Error('Required parameter accountNumber was null or undefined when calling gETOrdersByInvoiceOwner.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GetOrdersResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     * @param endDate The result will only contain the orders with the date of \&#39;dateFilterOption\&#39; earlier than or equal to this date. 
     */
    public async gETOrdersBySubscriptionNumber (subscriptionNumber: string, zuoraTrackId?: string, zuoraEntityIds?: string, page?: number, pageSize?: number, dateFilterOption?: string, startDate?: string, endDate?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GetOrdersResponse;  }> {
        const localVarPath = this.basePath + '/v1/orders/subscription/{subscriptionNumber}'
            .replace('{' + 'subscriptionNumber' + '}', encodeURIComponent(String(subscriptionNumber)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'subscriptionNumber' is not null or undefined
        if (subscriptionNumber === null || subscriptionNumber === undefined) {
            throw new Error('Required parameter subscriptionNumber was null or undefined when calling gETOrdersBySubscriptionNumber.');
        }
     ...
     * @param accountNumber The subscription owner account number.
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param page The page number of the orders retrieved. The default is 1. 
     * @param pageSize Number of rows returned per page. 
     ...
     * @param endDate The result will only contain the orders with the date of \&#39;dateFilterOption\&#39; earlier than or equal to this date. 
     */
    public async gETOrdersBySubscriptionOwner (accountNumber: string, zuoraTrackId?: string, zuoraEntityIds?: string, page?: number, pageSize?: number, dateFilterOption?: string, startDate?: string, endDate?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GetOrdersResponse;  }> {
        const localVarPath = this.basePath + '/v1/orders/subscriptionOwner/{accountNumber}'
            .replace('{' + 'accountNumber' + '}', encodeURIComponent(String(accountNumber)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'accountNumber' is not null or undefined
        if (accountNumber === null || accountNumber === undefined) {
            throw new Error('Required parameter accountNumber was null or undefined when calling gETOrdersBySubscriptionOwner.');
        }
     ...
     * @param subscriptionNumber The number of the subscription to retrieve terms for. For example, A-S00000001. 
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param version The version of the subscription to retrieve terms for. If you do not specify this parameter, Zuora returns the terms for the latest version of the subscription. 
     * @param page The page number of the terms retrieved. 
     * @param pageSize Number of rows returned per page. 
     */
    public async gETSubscriptionTermInfo (subscriptionNumber: string, zuoraTrackId?: string, zuoraEntityIds?: string, version?: number, page?: number, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GetSubscriptionTermInfoResponseType;  }> {
        const localVarPath = this.basePath + '/v1/orders/term/{subscriptionNumber}'
            .replace('{' + 'subscriptionNumber' + '}', encodeURIComponent(String(subscriptionNumber)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'subscriptionNumber' is not null or undefined
        if (subscriptionNumber === null || subscriptionNumber === undefined) {
            throw new Error('Required parameter subscriptionNumber was null or undefined when calling gETSubscriptionTermInfo.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GetSubscriptionTermInfoResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GetSubscriptionTermInfoResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param zuoraVersion  The minor version of the Zuora REST API.   You need to set this parameter if you use the following fields: * subscriptions * subscriptionNumbers 
     */
    public async pOSTCreateOrderAsynchronously (body: POSTOrderRequestType, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: InlineResponse202;  }> {
        const localVarPath = this.basePath + '/v1/async/orders';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pOSTCreateOrderAsynchronously.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "POSTOrderRequestType")
        };
     ...
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param returnIds Specify whether to return IDs associated with the numbers returned in the Create Order operation. 
     * @param zuoraVersion  The minor version of the Zuora REST API.   You need to set this parameter if you use the following fields: * subscriptions * subscriptionNumbers 
     */
    public async pOSTOrder (body: POSTOrderRequestType, zuoraTrackId?: string, zuoraEntityIds?: string, returnIds?: boolean, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: PostOrderResponseType;  }> {
        const localVarPath = this.basePath + '/v1/orders';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pOSTOrder.');
        }

        if (returnIds !== undefined) {
            localVarQueryParameters['returnIds'] = ObjectSerializer.serialize(returnIds, "boolean");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: PostOrderResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PostOrderResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pOSTPreviewOrder (body: POSTOrderPreviewRequestType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: PostOrderPreviewResponseType;  }> {
        const localVarPath = this.basePath + '/v1/orders/preview';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pOSTPreviewOrder.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "POSTOrderPreviewRequestType")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: PostOrderPreviewResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PostOrderPreviewResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pOSTPreviewOrderAsynchronously (body: POSTOrderPreviewRequestType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: InlineResponse202;  }> {
        const localVarPath = this.basePath + '/v1/async/orders/preview';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pOSTPreviewOrderAsynchronously.');
        }
     ...
     * @param orderNumber Order number of a pending order in which you are to update an order action\&#39;s triggering dates.
     * @param body 
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTOrderTriggerDates (orderNumber: string, body: PUTOrderActionTriggerDatesRequestType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: PUTOrderTriggerDatesResponseType;  }> {
        const localVarPath = this.basePath + '/v1/orders/{orderNumber}/triggerDates'
            .replace('{' + 'orderNumber' + '}', encodeURIComponent(String(orderNumber)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'orderNumber' is not null or undefined
        if (orderNumber === null || orderNumber === undefined) {
            throw new Error('Required parameter orderNumber was null or undefined when calling pUTOrderTriggerDates.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pUTOrderTriggerDates.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "PUTOrderActionTriggerDatesRequestType")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: PUTOrderTriggerDatesResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PUTOrderTriggerDatesResponseType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTUpdateOrderCustomFields (orderNumber: string, body: PUTOrderPatchRequestType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/orders/{orderNumber}/customFields'
            .replace('{' + 'orderNumber' + '}', encodeURIComponent(String(orderNumber)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'orderNumber' is not null or undefined
        if (orderNumber === null || orderNumber === undefined) {
            throw new Error('Required parameter orderNumber was null or undefined when calling pUTUpdateOrderCustomFields.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pUTUpdateOrderCustomFields.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "PUTOrderPatchRequestType")
        };
     ...
     * @param subscriptionNumber The subscription number to be updated.
     * @param body 
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTUpdateSubscriptionCustomFields (subscriptionNumber: string, body: PUTSubscriptionPatchRequestType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/subscriptions/{subscriptionNumber}/customFields'
            .replace('{' + 'subscriptionNumber' + '}', encodeURIComponent(String(subscriptionNumber)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'subscriptionNumber' is not null or undefined
        if (subscriptionNumber === null || subscriptionNumber === undefined) {
            throw new Error('Required parameter subscriptionNumber was null or undefined when calling pUTUpdateSubscriptionCustomFields.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pUTUpdateSubscriptionCustomFields.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "PUTSubscriptionPatchRequestType")
        };
