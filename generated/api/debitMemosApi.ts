...
import { DebitMemoFromChargeType } from '../model/debitMemoFromChargeType';
import { GETDebitMemoCollectionType } from '../model/gETDebitMemoCollectionType';
import { GETDebitMemoItemCollectionType } from '../model/gETDebitMemoItemCollectionType';
import { GETDebitMemoItemType } from '../model/gETDebitMemoItemType';
import { GETDebitMemoType } from '../model/gETDebitMemoType';
import { GETTaxationItemListType } from '../model/gETTaxationItemListType';
import { GETTaxationItemsOfDebitMemoItemType } from '../model/gETTaxationItemsOfDebitMemoItemType';
import { GetDebitMemoApplicationPartCollectionType } from '../model/getDebitMemoApplicationPartCollectionType';
import { POSTMemoPdfResponse } from '../model/pOSTMemoPdfResponse';
import { POSTTaxationItemListForDMType } from '../model/pOSTTaxationItemListForDMType';
import { POSTUploadFileResponse } from '../model/pOSTUploadFileResponse';
import { PUTBatchDebitMemosRequest } from '../model/pUTBatchDebitMemosRequest';
import { PUTDebitMemoType } from '../model/pUTDebitMemoType';
import { PostDebitMemoEmailType } from '../model/postDebitMemoEmailType';
...
export enum DebitMemosApiApiKeys {
}

export class DebitMemosApi {
    ...
    public setApiKey(key: DebitMemosApiApiKeys, value: string) {
        (this.authentications as any)[DebitMemosApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async dELETEDebitMemo (debitMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos/{debitMemoId}'
        ...
        if (debitMemoId === null || debitMemoId === undefined) {
            throw new Error('Required parameter debitMemoId was null or undefined when calling dELETEDebitMemo.');
        }
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async gETDebitMemo (debitMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETDebitMemoType;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos/{debitMemoId}'
            .replace('{' + 'debitMemoId' + '}', encodeURIComponent(String(debitMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'debitMemoId' is not null or undefined
        if (debitMemoId === null || debitMemoId === undefined) {
            throw new Error('Required parameter debitMemoId was null or undefined when calling gETDebitMemo.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETDebitMemoType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETDebitMemoType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async gETDebitMemoApplicationParts (debitMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GetDebitMemoApplicationPartCollectionType;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos/{debitMemoId}/application-parts'
            .replace('{' + 'debitMemoId' + '}', encodeURIComponent(String(debitMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'debitMemoId' is not null or undefined
        if (debitMemoId === null || debitMemoId === undefined) {
            throw new Error('Required parameter debitMemoId was null or undefined when calling gETDebitMemoApplicationParts.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GetDebitMemoApplicationPartCollectionType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GetDebitMemoApplicationPartCollectionType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async gETDebitMemoItem (dmitemid: string, debitMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETDebitMemoItemType;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos/{debitMemoId}/items/{dmitemid}'
        ...
        if (dmitemid === null || dmitemid === undefined) {
            throw new Error('Required parameter dmitemid was null or undefined when calling gETDebitMemoItem.');
        }

        // verify required parameter 'debitMemoId' is not null or undefined
        if (debitMemoId === null || debitMemoId === undefined) {
            throw new Error('Required parameter debitMemoId was null or undefined when calling gETDebitMemoItem.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETDebitMemoItemType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETDebitMemoItemType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param beAppliedAmount This parameter filters the response based on the &#x60;beAppliedAmount&#x60; field. 
     ...
     */
    public async gETDebitMemoItems (debitMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, zuoraVersion?: string, amount?: number, beAppliedAmount?: number, createdById?: string, createdDate?: Date, id?: string, serviceEndDate?: string, serviceStartDate?: string, sku?: string, skuName?: string, sourceItemId?: string, subscriptionId?: string, updatedById?: string, updatedDate?: Date, sort?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETDebitMemoItemCollectionType;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos/{debitMemoId}/items'
            .replace('{' + 'debitMemoId' + '}', encodeURIComponent(String(debitMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'debitMemoId' is not null or undefined
        if (debitMemoId === null || debitMemoId === undefined) {
            throw new Error('Required parameter debitMemoId was null or undefined when calling gETDebitMemoItems.');
        }
        ...
        if (beAppliedAmount !== undefined) {
            localVarQueryParameters['beAppliedAmount'] = ObjectSerializer.serialize(beAppliedAmount, "number");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETDebitMemoItemCollectionType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETDebitMemoItemCollectionType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param debitMemoDate This parameter filters the response based on the &#x60;debitMemoDate&#x60; field. 
     * @param dueDate This parameter filters the response based on the &#x60;dueDate&#x60; field. 
     ...
     */
    public async gETDebitMemos (zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, accountId?: string, amount?: number, balance?: number, beAppliedAmount?: number, createdById?: string, createdDate?: Date, currency?: string, debitMemoDate?: string, dueDate?: string, number?: string, referredInvoiceId?: string, status?: 'Draft' | 'Posted' | 'Canceled' | 'Error' | 'PendingForTax' | 'Generating' | 'CancelInProgress', targetDate?: string, taxAmount?: number, totalTaxExemptAmount?: number, updatedById?: string, updatedDate?: Date, sort?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETDebitMemoCollectionType;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (debitMemoDate !== undefined) {
            localVarQueryParameters['debitMemoDate'] = ObjectSerializer.serialize(debitMemoDate, "string");
        }

        if (dueDate !== undefined) {
            localVarQueryParameters['dueDate'] = ObjectSerializer.serialize(dueDate, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETDebitMemoCollectionType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETDebitMemoCollectionType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async gETTaxationItemsOfDebitMemoItem (dmitemid: string, debitMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, page?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETTaxationItemsOfDebitMemoItemType;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos/{debitMemoId}/items/{dmitemid}/taxation-items'
            .replace('{' + 'dmitemid' + '}', encodeURIComponent(String(dmitemid)))
            .replace('{' + 'debitMemoId' + '}', encodeURIComponent(String(debitMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'dmitemid' is not null or undefined
        if (dmitemid === null || dmitemid === undefined) {
            throw new Error('Required parameter dmitemid was null or undefined when calling gETTaxationItemsOfDebitMemoItem.');
        }

        // verify required parameter 'debitMemoId' is not null or undefined
        if (debitMemoId === null || debitMemoId === undefined) {
            throw new Error('Required parameter debitMemoId was null or undefined when calling gETTaxationItemsOfDebitMemoItem.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETTaxationItemsOfDebitMemoItemType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETTaxationItemsOfDebitMemoItemType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pOSTDMTaxationItems (debitMemoId: string, body: POSTTaxationItemListForDMType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETTaxationItemListType;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos/{debitMemoId}/taxationitems'
            .replace('{' + 'debitMemoId' + '}', encodeURIComponent(String(debitMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'debitMemoId' is not null or undefined
        if (debitMemoId === null || debitMemoId === undefined) {
            throw new Error('Required parameter debitMemoId was null or undefined when calling pOSTDMTaxationItems.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pOSTDMTaxationItems.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "POSTTaxationItemListForDMType")
        };
     ...
     */
    public async pOSTDebitMemoFromPrpc (body: DebitMemoFromChargeType, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETDebitMemoType;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pOSTDebitMemoFromPrpc.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "DebitMemoFromChargeType")
        };
     ...
     * @param debitMemoId The unique ID of the debit memo that you want to create a PDF file for. For example, 8a8082e65b27f6c3015ba419f3c2644e. 
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pOSTDebitMemoPDF (debitMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: POSTMemoPdfResponse;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos/{debitMemoId}/pdfs'
            .replace('{' + 'debitMemoId' + '}', encodeURIComponent(String(debitMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'debitMemoId' is not null or undefined
        if (debitMemoId === null || debitMemoId === undefined) {
            throw new Error('Required parameter debitMemoId was null or undefined when calling pOSTDebitMemoPDF.');
        }
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pOSTEmailDebitMemo (debitMemoId: string, request: PostDebitMemoEmailType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos/{debitMemoId}/emails'
            .replace('{' + 'debitMemoId' + '}', encodeURIComponent(String(debitMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'debitMemoId' is not null or undefined
        if (debitMemoId === null || debitMemoId === undefined) {
            throw new Error('Required parameter debitMemoId was null or undefined when calling pOSTEmailDebitMemo.');
        }

        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pOSTEmailDebitMemo.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "PostDebitMemoEmailType")
        };
     ...
     * @param debitMemoId The ID of the debit memo that you want to upload a PDF file for. For example, 402890555a87d7f5015a8919e4fe002e. 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param file The PDF file to upload for the debit memo. 
     */
    public async pOSTUploadFileForDebitMemo (debitMemoId: string, zuoraEntityIds?: string, zuoraTrackId?: string, file?: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: POSTUploadFileResponse;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos/{debitMemoId}/files'
            .replace('{' + 'debitMemoId' + '}', encodeURIComponent(String(debitMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'debitMemoId' is not null or undefined
        if (debitMemoId === null || debitMemoId === undefined) {
            throw new Error('Required parameter debitMemoId was null or undefined when calling pOSTUploadFileForDebitMemo.');
        }
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTBatchUpdateDebitMemos (body: PUTBatchDebitMemosRequest, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pUTBatchUpdateDebitMemos.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "PUTBatchDebitMemosRequest")
        };
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTCancelDebitMemo (debitMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETDebitMemoType;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos/{debitMemoId}/cancel'
            .replace('{' + 'debitMemoId' + '}', encodeURIComponent(String(debitMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'debitMemoId' is not null or undefined
        if (debitMemoId === null || debitMemoId === undefined) {
            throw new Error('Required parameter debitMemoId was null or undefined when calling pUTCancelDebitMemo.');
        }
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTDebitMemo (debitMemoId: string, body: PUTDebitMemoType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETDebitMemoType;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos/{debitMemoId}'
            .replace('{' + 'debitMemoId' + '}', encodeURIComponent(String(debitMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'debitMemoId' is not null or undefined
        if (debitMemoId === null || debitMemoId === undefined) {
            throw new Error('Required parameter debitMemoId was null or undefined when calling pUTDebitMemo.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pUTDebitMemo.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "PUTDebitMemoType")
        };
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTPostDebitMemo (debitMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETDebitMemoType;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos/{debitMemoId}/post'
            .replace('{' + 'debitMemoId' + '}', encodeURIComponent(String(debitMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'debitMemoId' is not null or undefined
        if (debitMemoId === null || debitMemoId === undefined) {
            throw new Error('Required parameter debitMemoId was null or undefined when calling pUTPostDebitMemo.');
        }
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTUnpostDebitMemo (debitMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETDebitMemoType;  }> {
        const localVarPath = this.basePath + '/v1/debitmemos/{debitMemoId}/unpost'
            .replace('{' + 'debitMemoId' + '}', encodeURIComponent(String(debitMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'debitMemoId' is not null or undefined
        if (debitMemoId === null || debitMemoId === undefined) {
            throw new Error('Required parameter debitMemoId was null or undefined when calling pUTUnpostDebitMemo.');
        }
