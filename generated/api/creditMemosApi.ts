...
import { ApplyCreditMemoType } from '../model/applyCreditMemoType';
import { CommonResponseType } from '../model/commonResponseType';
import { CreditMemoFromChargeType } from '../model/creditMemoFromChargeType';
import { GETCreditMemoCollectionType } from '../model/gETCreditMemoCollectionType';
import { GETCreditMemoItemPartType } from '../model/gETCreditMemoItemPartType';
import { GETCreditMemoItemPartsCollectionType } from '../model/gETCreditMemoItemPartsCollectionType';
import { GETCreditMemoItemType } from '../model/gETCreditMemoItemType';
import { GETCreditMemoItemsListType } from '../model/gETCreditMemoItemsListType';
import { GETCreditMemoPartType } from '../model/gETCreditMemoPartType';
import { GETCreditMemoPartsCollectionType } from '../model/gETCreditMemoPartsCollectionType';
import { GETCreditMemoType } from '../model/gETCreditMemoType';
import { GETRefundCreditMemoType } from '../model/gETRefundCreditMemoType';
import { GETTaxationItemListType } from '../model/gETTaxationItemListType';
import { GETTaxationItemsOfCreditMemoItemType } from '../model/gETTaxationItemsOfCreditMemoItemType';
import { POSTMemoPdfResponse } from '../model/pOSTMemoPdfResponse';
import { POSTTaxationItemListForCMType } from '../model/pOSTTaxationItemListForCMType';
import { POSTUploadFileResponse } from '../model/pOSTUploadFileResponse';
import { PUTCreditMemoType } from '../model/pUTCreditMemoType';
import { PostCreditMemoEmailRequestType } from '../model/postCreditMemoEmailRequestType';
import { PostNonRefRefundType } from '../model/postNonRefRefundType';
import { UnapplyCreditMemoType } from '../model/unapplyCreditMemoType';

import { ObjectSerializer, Authentication, VoidAuth, Interceptor } from '../model/models';

import { HttpError, RequestFile } from './apis';

let defaultBasePath = 'https://rest.zuora.com';

// ===============================================
// This file is autogenerated - Please do not edit
// ===============================================

export enum CreditMemosApiApiKeys {
}

export class CreditMemosApi {
    ...
    public setApiKey(key: CreditMemosApiApiKeys, value: string) {
        (this.authentications as any)[CreditMemosApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async dELETECreditMemo (creditMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}'
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling dELETECreditMemo.');
        }

        localVarHeaderParams['Zuora-Track-Id'] = ObjectSerializer.serialize(zuoraTrackId, "string");
        localVarHeaderParams['Zuora-Entity-Ids'] = ObjectSerializer.serialize(zuoraEntityIds, "string");
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: CommonResponseType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CommonResponseType");
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async gETCreditMemo (creditMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETCreditMemoType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}'
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETCreditMemoType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETCreditMemoType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async gETCreditMemoItem (cmitemid: string, creditMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETCreditMemoItemType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/items/{cmitemid}'
        ...
        if (cmitemid === null || cmitemid === undefined) {
            throw new Error('Required parameter cmitemid was null or undefined when calling gETCreditMemoItem.');
        }

        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling gETCreditMemoItem.');
        }

        localVarHeaderParams['Zuora-Track-Id'] = ObjectSerializer.serialize(zuoraTrackId, "string");
        localVarHeaderParams['Zuora-Entity-Ids'] = ObjectSerializer.serialize(zuoraEntityIds, "string");
        localVarHeaderParams['zuora-version'] = ObjectSerializer.serialize(zuoraVersion, "string");
        (<any>Object).assign(localVarHeaderParams, options.headers);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETCreditMemoItemType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETCreditMemoItemType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async gETCreditMemoItemPart (partid: string, itempartid: string, creditMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETCreditMemoItemPartType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/parts/{partid}/itemparts/{itempartid}'
        ...
        if (partid === null || partid === undefined) {
            throw new Error('Required parameter partid was null or undefined when calling gETCreditMemoItemPart.');
        }

        // verify required parameter 'itempartid' is not null or undefined
        if (itempartid === null || itempartid === undefined) {
            throw new Error('Required parameter itempartid was null or undefined when calling gETCreditMemoItemPart.');
        }

        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling gETCreditMemoItemPart.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETCreditMemoItemPartType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETCreditMemoItemPartType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async gETCreditMemoItemParts (partid: string, creditMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETCreditMemoItemPartsCollectionType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/parts/{partid}/itemparts'
            .replace('{' + 'partid' + '}', encodeURIComponent(String(partid)))
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'partid' is not null or undefined
        if (partid === null || partid === undefined) {
            throw new Error('Required parameter partid was null or undefined when calling gETCreditMemoItemParts.');
        }

        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling gETCreditMemoItemParts.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETCreditMemoItemPartsCollectionType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETCreditMemoItemPartsCollectionType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param appliedAmount This parameter filters the response based on the &#x60;appliedAmount&#x60; field. 
     * @param createdById This parameter filters the response based on the &#x60;createdById&#x60; field.  
     * @param createdDate This parameter filters the response based on the &#x60;createdDate&#x60; field.  
     * @param id This parameter filters the response based on the &#x60;id&#x60; field.  
     * @param refundAmount This parameter filters the response based on the &#x60;refundAmount&#x60; field.  
     * @param serviceEndDate This parameter filters the response based on the &#x60;serviceEndDate&#x60; field.  
     * @param serviceStartDate This parameter filters the response based on the &#x60;serviceStartDate&#x60; field.  
     * @param sku This parameter filters the response based on the &#x60;sku&#x60; field.  
     * @param skuName This parameter filters the response based on the &#x60;skuName&#x60; field.  
     * @param sourceItemId This parameter filters the response based on the &#x60;sourceItemId&#x60; field.  
     * @param subscriptionId This parameter filters the response based on the &#x60;subscriptionId&#x60; field. 
     * @param updatedById This parameter filters the response based on the &#x60;updatedById&#x60; field.  
     * @param updatedDate This parameter filters the response based on the &#x60;updatedDate&#x60; field. 
     ...
     */
    public async gETCreditMemoItems (creditMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, zuoraVersion?: string, amount?: number, appliedAmount?: number, createdById?: string, createdDate?: Date, id?: string, refundAmount?: number, serviceEndDate?: string, serviceStartDate?: string, sku?: string, skuName?: string, sourceItemId?: string, subscriptionId?: string, updatedById?: string, updatedDate?: Date, sort?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETCreditMemoItemsListType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/items'
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling gETCreditMemoItems.');
        }
        ...
        if (appliedAmount !== undefined) {
            localVarQueryParameters['appliedAmount'] = ObjectSerializer.serialize(appliedAmount, "number");
        }

        if (createdById !== undefined) {
            localVarQueryParameters['createdById'] = ObjectSerializer.serialize(createdById, "string");
        }

        if (createdDate !== undefined) {
            localVarQueryParameters['createdDate'] = ObjectSerializer.serialize(createdDate, "Date");
        }
        ...
        if (refundAmount !== undefined) {
            localVarQueryParameters['refundAmount'] = ObjectSerializer.serialize(refundAmount, "number");
        }

        if (serviceEndDate !== undefined) {
            localVarQueryParameters['serviceEndDate'] = ObjectSerializer.serialize(serviceEndDate, "string");
        }

        if (serviceStartDate !== undefined) {
            localVarQueryParameters['serviceStartDate'] = ObjectSerializer.serialize(serviceStartDate, "string");
        }

        if (sku !== undefined) {
            localVarQueryParameters['sku'] = ObjectSerializer.serialize(sku, "string");
        }

        if (skuName !== undefined) {
            localVarQueryParameters['skuName'] = ObjectSerializer.serialize(skuName, "string");
        }

        if (sourceItemId !== undefined) {
            localVarQueryParameters['sourceItemId'] = ObjectSerializer.serialize(sourceItemId, "string");
        }
        ...
        if (updatedById !== undefined) {
            localVarQueryParameters['updatedById'] = ObjectSerializer.serialize(updatedById, "string");
        }

        if (updatedDate !== undefined) {
            localVarQueryParameters['updatedDate'] = ObjectSerializer.serialize(updatedDate, "Date");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETCreditMemoItemsListType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETCreditMemoItemsListType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async gETCreditMemoPart (partid: string, creditMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETCreditMemoPartType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/parts/{partid}'
            .replace('{' + 'partid' + '}', encodeURIComponent(String(partid)))
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'partid' is not null or undefined
        if (partid === null || partid === undefined) {
            throw new Error('Required parameter partid was null or undefined when calling gETCreditMemoPart.');
        }

        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling gETCreditMemoPart.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETCreditMemoPartType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETCreditMemoPartType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param pageSize Number of rows returned per page. 
     */
    public async gETCreditMemoParts (creditMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETCreditMemoPartsCollectionType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/parts'
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling gETCreditMemoParts.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETCreditMemoPartsCollectionType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETCreditMemoPartsCollectionType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param pageSize Number of rows returned per page. 
     * @param accountId This parameter filters the response based on the &#x60;accountId&#x60; field.  
     * @param amount This parameter filters the response based on the &#x60;amount&#x60; field.  
     * @param appliedAmount This parameter filters the response based on the &#x60;appliedAmount&#x60; field.  
     * @param autoApplyUponPosting This parameter filters the response based on the &#x60;autoApplyUponPosting&#x60; field.  
     * @param createdById This parameter filters the response based on the &#x60;createdById&#x60; field.  
     * @param createdDate This parameter filters the response based on the &#x60;createdDate&#x60; field.  
     * @param creditMemoDate This parameter filters the response based on the &#x60;creditMemoDate&#x60; field.  
     * @param currency This parameter filters the response based on the &#x60;currency&#x60; field.  
     * @param excludeFromAutoApplyRules This parameter filters the response based on the &#x60;excludeFromAutoApplyRules&#x60; field.  
     * @param number This parameter filters the response based on the &#x60;number&#x60; field.  
     * @param referredInvoiceId This parameter filters the response based on the &#x60;referredInvoiceId&#x60; field.  
     * @param refundAmount This parameter filters the response based on the &#x60;refundAmount&#x60; field.  
     * @param status This parameter filters the response based on the &#x60;status&#x60; field.  
     * @param targetDate This parameter filters the response based on the &#x60;targetDate&#x60; field.  
     * @param taxAmount This parameter filters the response based on the &#x60;taxAmount&#x60; field.  
     * @param totalTaxExemptAmount This parameter filters the response based on the &#x60;totalTaxExemptAmount&#x60; field. 
     * @param transferredToAccounting This parameter filters the response based on the &#x60;transferredToAccounting&#x60; field.  
     * @param unappliedAmount This parameter filters the response based on the &#x60;unappliedAmount&#x60; field.  
     * @param updatedById This parameter filters the response based on the &#x60;updatedById&#x60; field.  
     * @param updatedDate This parameter filters the response based on the &#x60;updatedDate&#x60; field. 
     ...
     */
    public async gETCreditMemos (zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, accountId?: string, amount?: number, appliedAmount?: number, autoApplyUponPosting?: boolean, createdById?: string, createdDate?: Date, creditMemoDate?: string, currency?: string, excludeFromAutoApplyRules?: boolean, number?: string, referredInvoiceId?: string, refundAmount?: number, status?: 'Draft' | 'Posted' | 'Canceled' | 'Error' | 'PendingForTax' | 'Generating' | 'CancelInProgress', targetDate?: string, taxAmount?: number, totalTaxExemptAmount?: number, transferredToAccounting?: 'Processing' | 'Yes' | 'No' | 'Error' | 'Ignore', unappliedAmount?: number, updatedById?: string, updatedDate?: Date, sort?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETCreditMemoCollectionType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        // give precedence to 'application/json'
        ...
        if (autoApplyUponPosting !== undefined) {
            localVarQueryParameters['autoApplyUponPosting'] = ObjectSerializer.serialize(autoApplyUponPosting, "boolean");
        }
        ...
        if (creditMemoDate !== undefined) {
            localVarQueryParameters['creditMemoDate'] = ObjectSerializer.serialize(creditMemoDate, "string");
        }
        ...
        if (excludeFromAutoApplyRules !== undefined) {
            localVarQueryParameters['excludeFromAutoApplyRules'] = ObjectSerializer.serialize(excludeFromAutoApplyRules, "boolean");
        }

        if (number !== undefined) {
            localVarQueryParameters['number'] = ObjectSerializer.serialize(number, "string");
        }

        if (referredInvoiceId !== undefined) {
            localVarQueryParameters['referredInvoiceId'] = ObjectSerializer.serialize(referredInvoiceId, "string");
        }
        ...
        if (status !== undefined) {
            localVarQueryParameters['status'] = ObjectSerializer.serialize(status, "'Draft' | 'Posted' | 'Canceled' | 'Error' | 'PendingForTax' | 'Generating' | 'CancelInProgress'");
        }

        if (targetDate !== undefined) {
            localVarQueryParameters['targetDate'] = ObjectSerializer.serialize(targetDate, "string");
        }

        if (taxAmount !== undefined) {
            localVarQueryParameters['taxAmount'] = ObjectSerializer.serialize(taxAmount, "number");
        }

        if (totalTaxExemptAmount !== undefined) {
            localVarQueryParameters['totalTaxExemptAmount'] = ObjectSerializer.serialize(totalTaxExemptAmount, "number");
        }

        if (transferredToAccounting !== undefined) {
            localVarQueryParameters['transferredToAccounting'] = ObjectSerializer.serialize(transferredToAccounting, "'Processing' | 'Yes' | 'No' | 'Error' | 'Ignore'");
        }

        if (unappliedAmount !== undefined) {
            localVarQueryParameters['unappliedAmount'] = ObjectSerializer.serialize(unappliedAmount, "number");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETCreditMemoCollectionType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETCreditMemoCollectionType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async gETTaxationItemsOfCreditMemoItem (cmitemid: string, creditMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, pageSize?: number, page?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETTaxationItemsOfCreditMemoItemType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/items/{cmitemid}/taxation-items'
            .replace('{' + 'cmitemid' + '}', encodeURIComponent(String(cmitemid)))
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'cmitemid' is not null or undefined
        if (cmitemid === null || cmitemid === undefined) {
            throw new Error('Required parameter cmitemid was null or undefined when calling gETTaxationItemsOfCreditMemoItem.');
        }

        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling gETTaxationItemsOfCreditMemoItem.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETTaxationItemsOfCreditMemoItemType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETTaxationItemsOfCreditMemoItemType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pOSTCMTaxationItems (creditMemoId: string, body: POSTTaxationItemListForCMType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETTaxationItemListType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/taxationitems'
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling pOSTCMTaxationItems.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pOSTCMTaxationItems.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "POSTTaxationItemListForCMType")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETTaxationItemListType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETTaxationItemListType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async pOSTCreditMemoFromPrpc (body: CreditMemoFromChargeType, zuoraTrackId?: string, zuoraEntityIds?: string, zuoraVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETCreditMemoType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pOSTCreditMemoFromPrpc.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "CreditMemoFromChargeType")
        };
     ...
     * @param creditMemoId The unique ID of the credit memo that you want to create a PDF file for. For example, 8a8082e65b27f6c3015ba45ff82c7172. 
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pOSTCreditMemoPDF (creditMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: POSTMemoPdfResponse;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/pdfs'
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling pOSTCreditMemoPDF.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: POSTMemoPdfResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "POSTMemoPdfResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pOSTEmailCreditMemo (creditMemoId: string, request: PostCreditMemoEmailRequestType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: CommonResponseType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/emails'
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling pOSTEmailCreditMemo.');
        }

        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling pOSTEmailCreditMemo.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "PostCreditMemoEmailRequestType")
        };
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pOSTRefundCreditMemo (creditmemoId: string, body: PostNonRefRefundType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETRefundCreditMemoType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditmemoId}/refunds'
            .replace('{' + 'creditmemoId' + '}', encodeURIComponent(String(creditmemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'creditmemoId' is not null or undefined
        if (creditmemoId === null || creditmemoId === undefined) {
            throw new Error('Required parameter creditmemoId was null or undefined when calling pOSTRefundCreditMemo.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pOSTRefundCreditMemo.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "PostNonRefRefundType")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: GETRefundCreditMemoType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GETRefundCreditMemoType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param creditMemoId The ID of the credit memo that you want to upload a PDF file for. For example, 402890555a7e9791015a879f064a0054. 
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     * @param zuoraTrackId A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;\&#39;&#x60;). 
     * @param file The PDF file to upload for the credit memo. 
     */
    public async pOSTUploadFileForCreditMemo (creditMemoId: string, zuoraEntityIds?: string, zuoraTrackId?: string, file?: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: POSTUploadFileResponse;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/files'
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling pOSTUploadFileForCreditMemo.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.ClientResponse; body: POSTUploadFileResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "POSTUploadFileResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTApplyCreditMemo (creditMemoId: string, body: ApplyCreditMemoType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETCreditMemoType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/apply'
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling pUTApplyCreditMemo.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pUTApplyCreditMemo.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "ApplyCreditMemoType")
        };
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTCancelCreditMemo (creditMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETCreditMemoType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/cancel'
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling pUTCancelCreditMemo.');
        }
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTPostCreditMemo (creditMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETCreditMemoType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/post'
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling pUTPostCreditMemo.');
        }
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTUnapplyCreditMemo (creditMemoId: string, body: UnapplyCreditMemoType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETCreditMemoType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/unapply'
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling pUTUnapplyCreditMemo.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pUTUnapplyCreditMemo.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "UnapplyCreditMemoType")
        };
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTUnpostCreditMemo (creditMemoId: string, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETCreditMemoType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}/unpost'
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json; charset=utf-8', 'application/json'];
        ...
        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling pUTUnpostCreditMemo.');
        }
     ...
     * @param zuoraEntityIds An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
     */
    public async pUTUpdateCreditMemo (creditMemoId: string, body: PUTCreditMemoType, zuoraTrackId?: string, zuoraEntityIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: GETCreditMemoType;  }> {
        const localVarPath = this.basePath + '/v1/creditmemos/{creditMemoId}'
            .replace('{' + 'creditMemoId' + '}', encodeURIComponent(String(creditMemoId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'creditMemoId' is not null or undefined
        if (creditMemoId === null || creditMemoId === undefined) {
            throw new Error('Required parameter creditMemoId was null or undefined when calling pUTUpdateCreditMemo.');
        }

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling pUTUpdateCreditMemo.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(body, "PUTCreditMemoType")
        };
