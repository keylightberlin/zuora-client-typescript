...
import { PUTSubscriptionTypeAllOf } from './pUTSubscriptionTypeAllOf';
...
export class PUTSubscriptionType {
    /**
    * Container for adding one or more rate plans. 
    */
    'add'?: Array<PUTSrpAddType>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "add",
            "baseName": "add",
            "type": "Array<PUTSrpAddType>"
        },
        {
            "name": "applyCreditBalance",
            "baseName": "applyCreditBalance",
            "type": "boolean"
        },
        {
            "name": "autoRenew",
        ...
        },
        {
            ...
            "baseName": "includeExistingDraftDocItems",
            "type": "boolean"
        },
        {
            "name": "includeExistingDraftInvoiceItems",
            "baseName": "includeExistingDraftInvoiceItems",
            "type": "boolean"
        },
        {
            "name": "invoice",
        ...
        {
            "name": "previewType",
            "baseName": "previewType",
            "type": "string"
        },
        {
            "name": "remove",
            "baseName": "remove",
            "type": "Array<PUTSrpRemoveType>"
        },
        {
            "name": "renewalSetting",
    ...
    static getAttributeTypeMap() {
        return PUTSubscriptionType.attributeTypeMap;
    }
}
