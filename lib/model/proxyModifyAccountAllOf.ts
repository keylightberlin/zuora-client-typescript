...
export class ProxyModifyAccountAllOf {
    /**
    ...
    */
    'status'?: ProxyModifyAccountAllOf.StatusEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "Status",
            "type": "ProxyModifyAccountAllOf.StatusEnum"
        },
        {
            "name": "taxCompanyCode",
    ...
    static getAttributeTypeMap() {
        return ProxyModifyAccountAllOf.attributeTypeMap;
    }
}

export namespace ProxyModifyAccountAllOf {
