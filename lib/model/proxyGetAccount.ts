...
import { ProxyGetAccountAllOf } from './proxyGetAccountAllOf';

export class ProxyGetAccount {
    /**
    ...
    */
    'status'?: ProxyGetAccount.StatusEnum;
    /**
    ...
    */
    'customerTypeNS'?: ProxyGetAccount.CustomerTypeNSEnum;
    /**
    ...
    */
    'synctoNetSuiteNS'?: ProxyGetAccount.SynctoNetSuiteNSEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "Status",
            "type": "ProxyGetAccount.StatusEnum"
        },
        {
            "name": "taxCompanyCode",
        ...
        },
        {
            ...
            "type": "ProxyGetAccount.CustomerTypeNSEnum"
        },
        {
            "name": "departmentNS",
        ...
        },
        {
            ...
            "type": "ProxyGetAccount.SynctoNetSuiteNSEnum"
        }    ];

    static getAttributeTypeMap() {
        return ProxyGetAccount.attributeTypeMap;
    }
}

export namespace ProxyGetAccount {
