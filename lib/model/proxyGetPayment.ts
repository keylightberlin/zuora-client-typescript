...
import { PaymentObjectNSFields } from './paymentObjectNSFields';
import { ProxyGetPaymentAllOf } from './proxyGetPaymentAllOf';

export class ProxyGetPayment {
    /**
    ...
    */
    'gatewayState'?: ProxyGetPayment.GatewayStateEnum;
    /**
    ...
    */
    'source'?: ProxyGetPayment.SourceEnum;
    /**
    * The name of the source. The value is a Payment Run number or a file name. 
    */
    'sourceName'?: string;
    /**
    * The status of the payment in Zuora. The value depends on the type of payment.  For electronic payments, the status can be `Processed`, `Processing`, `Error`, or `Voided`. For external payments, the status can be `Processed` or `Canceled`. 
    */
    'status'?: ProxyGetPayment.StatusEnum;
    /**
    ...
    */
    'transferredToAccounting'?: ProxyGetPayment.TransferredToAccountingEnum;
    /**
    * The type of the payment, whether the payment is external or electronic. 
    */
    'type'?: ProxyGetPayment.TypeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "baseName": "AppliedCreditBalanceAmount",
            "type": "number"
        },
        {
        ...
        {
            "name": "gatewayOrderId",
            "baseName": "GatewayOrderId",
            "type": "string"
        },
        {
            "name": "gatewayResponse",
            "baseName": "GatewayResponse",
            "type": "string"
        },
        {
            "name": "gatewayResponseCode",
            "baseName": "GatewayResponseCode",
            "type": "string"
        },
        {
            "name": "gatewayState",
            "baseName": "GatewayState",
            "type": "ProxyGetPayment.GatewayStateEnum"
        },
        {
            "name": "id",
            "baseName": "Id",
        ...
        },
        {
            ...
            "baseName": "MarkedForSubmissionOn",
            "type": "Date"
        },
        {
        ...
        },
        {
            ...
            "baseName": "PaymentMethodSnapshotId",
            "type": "string"
        },
        {
            "name": "paymentNumber",
            "baseName": "PaymentNumber",
            "type": "string"
        },
        {
            "name": "referenceId",
        ...
        },
        {
            ...
            "baseName": "SecondPaymentReferenceId",
            "type": "string"
        },
        {
            "name": "settledOn",
        ...
        {
            "name": "softDescriptor",
            "baseName": "SoftDescriptor",
            "type": "string"
        },
        {
            "name": "softDescriptorPhone",
            "baseName": "SoftDescriptorPhone",
            "type": "string"
        },
        {
            "name": "source",
            "baseName": "Source",
            "type": "ProxyGetPayment.SourceEnum"
        },
        {
            "name": "sourceName",
            "baseName": "SourceName",
        ...
        },
        {
            "name": "status",
            "baseName": "Status",
            "type": "ProxyGetPayment.StatusEnum"
        },
        {
            "name": "submittedOn",
        ...
        },
        {
            ...
            "baseName": "TransferredToAccounting",
            "type": "ProxyGetPayment.TransferredToAccountingEnum"
        },
        {
            "name": "type",
            "baseName": "Type",
        ...
        {
            "name": "transactionNS",
            "baseName": "Transaction__NS",
            "type": "string"
        }    ];

    static getAttributeTypeMap() {
        return ProxyGetPayment.attributeTypeMap;
    }
}

export namespace ProxyGetPayment {
    export enum GatewayStateEnum {
        MarkedForSubmission = <any> 'MarkedForSubmission',
        Submitted = <any> 'Submitted',
        Settled = <any> 'Settled',
        NotSubmitted = <any> 'NotSubmitted',
        FailedToSettle = <any> 'FailedToSettle'
    }
    export enum SourceEnum {
        PaymentRun = <any> 'PaymentRun',
        Import = <any> 'Import',
    ...
    export enum TransferredToAccountingEnum {
        Processing = <any> 'Processing',
        Yes = <any> 'Yes',
        Error = <any> 'Error',
        Ignore = <any> 'Ignore'
