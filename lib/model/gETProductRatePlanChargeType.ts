...
import { GETProductRatePlanChargeTypeAllOf } from './gETProductRatePlanChargeTypeAllOf';
import { ProductRatePlanChargeObjectNSFields } from './productRatePlanChargeObjectNSFields';

export class GETProductRatePlanChargeType {
    /**
    ...
    */
    'minQuantity'?: string;
    /**
    * Charge model which determines how charges are calculated. Charge models must be individually activated in Zuora Billing administration.   Possible values are: - FlatFee - PerUnit - Overage - Volume - Tiered - TieredWithOverage - DiscountFixedAmount - DiscountPercentage - MultiAttributePricing (available only if you have the Multi-Attribute Pricing charge model in *Early Adopter* phase enabled) - PreratedPerUnit (available only if you have the Pre-rated Per Unit Pricing charge model in *Early Adopter* phase enabled) - PreratedPricing (available only if you have the Pre-rated Pricing charge model in *Early Adopter* phase enabled) - HighWatermarkVolumePricing (available only if you have the High Watermark Volume Pricing charge model in *Early Adopter* phase enabled) - HighWatermarkTieredPricing (available only if you have the High Watermark Tiered Pricing in *Early Adopter* phase enabled)  The value of the `pricing` field contains details about these charge models and the value of `pricingSummary` field contains their associated pricing summary values. 
    */
    'model'?: string;
    /**
    ...
    */
    'productDiscountApplyDetails'?: Array<GETProductDiscountApplyDetailsType>;
    /**
    ...
    */
    'revRecTriggerCondition'?: GETProductRatePlanChargeType.RevRecTriggerConditionEnum;
    /**
    ...
    */
    'includeChildrenNS'?: GETProductRatePlanChargeType.IncludeChildrenNSEnum;
    /**
    ...
    */
    'itemTypeNS'?: GETProductRatePlanChargeType.ItemTypeNSEnum;
    /**
    ...
    */
    'revRecEndNS'?: GETProductRatePlanChargeType.RevRecEndNSEnum;
    /**
    ...
    */
    'revRecStartNS'?: GETProductRatePlanChargeType.RevRecStartNSEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "pricing",
            "baseName": "pricing",
            "type": "Array<GETProductRatePlanChargePricingType>"
        },
        {
            "name": "pricingSummary",
        ...
        {
            "name": "productDiscountApplyDetails",
            "baseName": "productDiscountApplyDetails",
            "type": "Array<GETProductDiscountApplyDetailsType>"
        },
        {
            "name": "ratingGroup",
            "baseName": "ratingGroup",
            "type": "string"
        },
        {
            "name": "revRecCode",
        ...
        },
        {
            ...
            "type": "GETProductRatePlanChargeType.RevRecTriggerConditionEnum"
        },
        {
        ...
        },
        {
            ...
            "baseName": "usageRecordRatingOption",
            "type": "string"
        },
        {
            "name": "useDiscountSpecificAccountingCode",
            "baseName": "useDiscountSpecificAccountingCode",
            "type": "boolean"
        },
        {
            "name": "useTenantDefaultForPriceChange",
            "baseName": "useTenantDefaultForPriceChange",
            "type": "boolean"
        },
        {
            "name": "classNS",
        ...
        {
            "name": "deferredRevAccountNS",
            "baseName": "DeferredRevAccount__NS",
            "type": "string"
        },
        {
            "name": "departmentNS",
        ...
        {
            "name": "includeChildrenNS",
            "baseName": "IncludeChildren__NS",
            "type": "GETProductRatePlanChargeType.IncludeChildrenNSEnum"
        },
        {
        ...
        {
            "name": "itemTypeNS",
            "baseName": "ItemType__NS",
            "type": "GETProductRatePlanChargeType.ItemTypeNSEnum"
        },
        {
            "name": "locationNS",
        ...
        {
            "name": "recognizedRevAccountNS",
            "baseName": "RecognizedRevAccount__NS",
            "type": "string"
        },
        {
            "name": "revRecEndNS",
            "baseName": "RevRecEnd__NS",
            "type": "GETProductRatePlanChargeType.RevRecEndNSEnum"
        },
        {
            "name": "revRecStartNS",
            "baseName": "RevRecStart__NS",
            "type": "GETProductRatePlanChargeType.RevRecStartNSEnum"
        },
        {
            "name": "revRecTemplateTypeNS",
            "baseName": "RevRecTemplateType__NS",
            "type": "string"
        },
        {
            "name": "subsidiaryNS",
    ...
    static getAttributeTypeMap() {
        return GETProductRatePlanChargeType.attributeTypeMap;
    }
}

export namespace GETProductRatePlanChargeType {
    export enum RevRecTriggerConditionEnum {
        ContractEffectiveDate = <any> 'ContractEffectiveDate',
        ServiceActivationDate = <any> 'ServiceActivationDate',
        CustomerAcceptanceDate = <any> 'CustomerAcceptanceDate'
    }
    export enum IncludeChildrenNSEnum {
        Yes = <any> 'Yes',
        No = <any> 'No'
    }
    export enum ItemTypeNSEnum {
        Inventory = <any> 'Inventory',
        NonInventory = <any> 'Non Inventory',
        Service = <any> 'Service'
    }
    export enum RevRecEndNSEnum {
        ChargePeriodStart = <any> 'Charge Period Start',
        RevRecTriggerDate = <any> 'Rev Rec Trigger Date',
        UseNetSuiteRevRecTemplate = <any> 'Use NetSuite Rev Rec Template'
    }
    export enum RevRecStartNSEnum {
        ChargePeriodStart = <any> 'Charge Period Start',
        RevRecTriggerDate = <any> 'Rev Rec Trigger Date',
        UseNetSuiteRevRecTemplate = <any> 'Use NetSuite Rev Rec Template'
    }
