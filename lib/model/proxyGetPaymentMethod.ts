...
export class ProxyGetPaymentMethod {
    /**
    ...
    */
    'achBankName'?: string;
    /**
    *  Specifies whether a payment method is available in Zuora. This field is used to indicate if a payment method is loaded by the system or created by the customer. - `true`: System loaded payment method. - `false`: Customer created payment method.  The default value is `false`. **Character limit**: 5 **Values**: `true`, `false` 
    */
    'active'?: boolean;
    /**
    ...
    */
    'type'?: ProxyGetPaymentMethod.TypeEnum;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return ProxyGetPaymentMethod.attributeTypeMap;
    }
}

export namespace ProxyGetPaymentMethod {
