...
export class ActionAmendInvoiceItem {
    /**
    ...
    */
    'productName'?: string;
    /**
    *  The ID of the rate plan charge that\'s associated with this invoice item.   **Character limit**: 32  **Values**: inherited from `ProductRatePlanCharge.Id` You cannot query for this field. Only the subscribe preview and the amend preview calls will return the value of this field in the response.
    */
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "baseName": "AppliedToInvoiceItemId",
            "type": "string"
        },
        {
            "name": "chargeAmount",
    ...
    static getAttributeTypeMap() {
        return ActionAmendInvoiceItem.attributeTypeMap;
    }
}
