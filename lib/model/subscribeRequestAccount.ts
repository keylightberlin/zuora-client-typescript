...
import { SubscribeRequestAccountAllOf } from './subscribeRequestAccountAllOf';
...
*/
export class SubscribeRequestAccount {
    /**
    ...
    */
    ...
    /**
    * ID of the default payment method for the account. This field is only required if the `AutoPay` field is set to `true`.   **Character limit**: 32   **Values**: A valid ID for an existing payment method. This field does not support external payment methods. 
    */
    ...
    */
    'customerTypeNS'?: SubscribeRequestAccount.CustomerTypeNSEnum;
    /**
    ...
    */
    'synctoNetSuiteNS'?: SubscribeRequestAccount.SynctoNetSuiteNSEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "SubscribeRequestAccount.CustomerTypeNSEnum"
        },
        {
            "name": "departmentNS",
        ...
        },
        {
            ...
            "type": "SubscribeRequestAccount.SynctoNetSuiteNSEnum"
        }    ];

    static getAttributeTypeMap() {
        return SubscribeRequestAccount.attributeTypeMap;
    }
}

export namespace SubscribeRequestAccount {
