...
import { ActionSubscribeInvoiceItemAllOf } from './actionSubscribeInvoiceItemAllOf';
import { InvoiceItemObjectNSFields } from './invoiceItemObjectNSFields';

export class ActionSubscribeInvoiceItem {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "baseName": "AppliedToChargeNumber",
            "type": "string"
        },
        {
    ...
    static getAttributeTypeMap() {
        return ActionSubscribeInvoiceItem.attributeTypeMap;
    }
}
